#!/usr/bin/env bash
# =============================================================================
# onboarding_nuevo_cliente.sh — Vigex
# R-084 / Ruta 11.1
#
...
section "PASO 6 — Integración con Vigex Central"
...
# ── Paso 8: Instalar Vigex ────────────────────────────────────────────────────
section "PASO 8 — Instalación de Vigex"
...
echo "  1. Verificar: systemctl status vigex-api"
