...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "panel.hello_prefix": "¡Hola, ", "panel.subtitle_ok": "Todo bajo control.",
        "panel.system_active": "Sistema activo", "panel.users_singular": "usuario",
        "panel.checking": "Comprobando…",
        "panel.stat_backup": "Última copia", "panel.stat_services": "Servicios",
        "panel.stat_alerts": "Alertas", "panel.stat_disk": "Disco del servidor",
        "panel.no_data": "Sin datos", "panel.all_active": "Todos activos",
        "panel.inactive_sg": " inactivo", "panel.inactive_pl": " inactivos",
        "panel.with_error": " con error", "panel.no_errors": "Sin errores",
        "panel.disk_full": "Lleno", "panel.disk_watch": "Vigilar", "panel.disk_free": "Libre",
        "panel.disk_of": " de ", "panel.disk_used_suf": " usado",
        "panel.badge_nd": "N/D", "panel.badge_attention": "Atención", "panel.badge_review": "Revisar",
        "panel.backups_title": "Copias de seguridad",
        "panel.backups_desc": "Protege tus datos con un clic. Programa copias automáticas y recupéralas cuando lo necesites.",
        "panel.backups_btn": "Abrir copias", "panel.backups_meta": "Cada copia verificada automáticamente",
        "panel.logs_title": "Logs y auditoría",
        "panel.logs_desc": "¿Algo fue raro? Aquí están todos los eventos del sistema, ordenados y fáciles de revisar.",
        "panel.logs_btn": "Ver logs", "panel.logs_meta": "Registros guardados de forma segura",
        "panel.servicios_title": "Servicios del sistema",
        "panel.servicios_desc": "Arranca, para o reinicia servicios del servidor sin tocar ningún cable. Todo desde aquí.",
        "panel.servicios_btn": "Gestionar servicios", "panel.servicios_meta": "Conexión cifrada al servidor",
        "panel.terminal_title": "Terminal remota",
        "panel.terminal_desc": "Acceso directo al servidor cuando lo necesitas. Rápido, seguro y sin salir del panel.",
        "panel.terminal_btn": "Abrir terminal", "panel.terminal_meta": "Solo comandos autorizados",
        "panel.alertas_title": "Alertas",
        "panel.alertas_desc": "Define quién recibe aviso y cuándo. El sistema te alerta por Telegram cuando algo necesita tu atención.",
        "panel.alertas_btn": "Gestionar alertas", "panel.alertas_meta": "Avisos al instante por Telegram",
        "panel.soporte_title": "Soporte Vigex",
        "panel.soporte_desc": "¿Algo no funciona como esperas? Abre un ticket y el equipo Vigex se encarga de solucionarlo.",
        "panel.soporte_btn": "Abrir soporte", "panel.soporte_meta": "Conectado a Vigex Central",
        "panel.admin_title": "Administración",
        "panel.admin_desc": "Dale acceso a tu equipo y decide exactamente qué puede ver o tocar cada persona.",
        "panel.admin_btn1": "Gestionar usuarios", "panel.admin_btn2": "Ver accesos",
        "panel.admin_meta": "Solo administrador",
        # monitoreo.html
        "mon.page_title": "Estado del servidor",
        "mon.page_subtitle": "CPU, memoria, disco y actividad en tiempo real. Sin necesidad de abrir nada más.",
        "mon.server_label": "Servidor", "mon.reads_label": "lecturas",
        "mon.autorefresh": "Actualización automática cada 30 s",
        "mon.loading": "Cargando…", "mon.connecting": "Conectando…",
        "mon.refresh_btn": "Actualizar ya",
        "mon.label_load": "Actividad (1 min)", "mon.label_mem": "Memoria RAM",
        "mon.label_disk": "Disco principal", "mon.label_uptime": "Tiempo activo",
        "mon.badge_active": "Activo",
        "mon.chart_title": "Carga del sistema — historial de esta sesión",
        "mon.chart_subtitle": "Una lectura cada 30 segundos. El historial se borra al salir de la página.",
        "mon.load_avg_title": "Actividad media del procesador",
        "mon.load_avg_desc": "Por debajo de 1.0 el servidor va bien. Si sube durante un rato por encima del número de núcleos disponibles, es que tiene trabajo acumulado.",
        "mon.load_1min": "1 minuto", "mon.load_5min": "5 minutos", "mon.load_15min": "15 minutos",
        "mon.no_data": "Sin datos del servidor",
        "mon.load_sub": "Actividad del último minuto",
        "mon.load_high": "Alta", "mon.load_med": "Moderada", "mon.load_ok": "Normal",
        "mon.mem_full": "Llena", "mon.mem_of": " de ", "mon.mem_used_suf": " usada",
        "mon.disk_full": "Lleno", "mon.disk_watch": "Vigilar", "mon.disk_free": "Libre",
        "mon.disk_of": " de ", "mon.disk_used_suf": " usado",
        "mon.reads_sg": " lectura", "mon.reads_pl": " lecturas",
        "mon.refresh_in": "Actualizando en ", "mon.refresh_s": " s", "mon.refreshing": "Actualizando…",
        "mon.uptime_sub": "Funcionando sin parar desde",
        # logs.html
        "logs.sidebar_title": "Resumen rápido", "logs.events_ok": "Eventos OK",
        "logs.events_error": "Con error", "logs.last": "Último",
        "logs.page_title": "Registro de actividad",
        "logs.page_subtitle": "Todo lo que pasa en el sistema, registrado y listo para revisar cuando lo necesites.",
        "logs.kpi_total": "Eventos cargados", "logs.kpi_ok": "Sin errores", "logs.kpi_errors": "Con errores",
        "logs.cacti_title": "Monitorización externa", "logs.cacti_desc": "Accede al sistema de gráficas de tu servidor.",
        "logs.cacti_btn": "Abrir Cacti",
        "logs.table_title": "Eventos de Vigex Web",
        "logs.table_desc": "Últimas 100 entradas del registro de actividad del panel.",
        "logs.th_fecha": "Fecha", "logs.th_origen": "Origen", "logs.th_tipo": "Tipo",
        "logs.th_usuario": "Usuario", "logs.th_recurso": "Qué ocurrió",
        "logs.th_resultado": "Resultado", "logs.th_detalle": "Detalle",
        "logs.empty": "No hay entradas que mostrar. Si la vista aparece vacía, puede haber un problema con la conexión al registro.",
        # backups.html
        "bkp.sidebar_title": "Estado del módulo", "bkp.sidebar_ready": "Listo para crear copias",
        "bkp.sidebar_inc": "Copias incrementales disponibles", "bkp.sidebar_access": "Acceso controlado",
        "bkp.msg_ok": "¡Copia creada correctamente!", "bkp.msg_error": "Algo falló al crear la copia. Vuelve a intentarlo.",
        "bkp.page_title": "Copias de seguridad",
        "bkp.page_subtitle": "Elige el tipo de copia que necesitas y ponla en marcha en segundos.",
        "bkp.integrity_btn": "Integridad",
        "bkp.create_title": "Crear copia", "bkp.create_desc": "Elige el tipo de backup y abre su formulario.",
        "bkp.btn_full": "Backup completo", "bkp.btn_inc": "Backup incremental", "bkp.btn_diff": "Backup diferencial",
        "bkp.notes_title": "Notas del producto", "bkp.notes_desc": "Ayudas y explicaciones intuitivas para el usuario.",
        "bkp.help_full_title": "Completo",
        "bkp.help_full_desc": "Crea una copia íntegra de la base de datos seleccionada. Es la opción más recomendable para copias iniciales, pruebas de restauración y puntos de seguridad claros antes de realizar cambios importantes.",
        "bkp.help_inc_title": "Incremental",
        "bkp.help_inc_desc": "Guarda solo los cambios desde la última copia. Ocupa mucho menos espacio y mantiene una cadena de protección diaria.",
        "bkp.help_diff_title": "Diferencial",
        "bkp.help_diff_desc": "Guarda los cambios desde la última copia completa. Es el punto medio: más rápida de restaurar que la incremental y más ligera que la completa.",
        "bkp.related_title": "Funciones relacionadas", "bkp.related_desc": "Más información para entender la evolución del módulo de copias.",
        "bkp.help_sched_title": "Copias automáticas y programadas",
        "bkp.help_sched_desc": "Permite definir copias periódicas para no depender de ejecuciones manuales. La idea es que el sistema pueda mantener una rutina estable de protección según la frecuencia configurada por el usuario.",
        "bkp.help_restore_title": "Restauración",
        "bkp.help_restore_desc": "Será la función encargada de recuperar un punto anterior de la base de datos a partir de una copia disponible. Está pensada para resolver errores, pérdidas de información o volver a un estado conocido del sistema.",
        "bkp.help_hist_title": "Historial de copias",
        "bkp.help_hist_desc": "Mostrará el registro de copias realizadas con su fecha, tipo, resultado y ubicación. De esta manera el usuario podrá revisar rápidamente qué se ha ejecutado y qué punto de respaldo tiene disponible.",
        "bkp.auto_title": "Programar copias automáticas",
        "bkp.auto_desc": "Decide cuándo quieres que se hagan las copias y olvídate. El sistema se encarga.",
        "bkp.callout_warn_bold": "Ten en cuenta:",
        "bkp.callout_warn_text": "las copias incrementales solo se pueden programar si ya existe una copia base de esa base de datos. Las diferenciales solo si ya existe una copia completa.",
        "bkp.field_type": "Tipo de copia", "bkp.field_db": "Base de datos", "bkp.field_dest": "Carpeta destino",
        "bkp.field_compress": "Compresión", "bkp.no_compress": "Sin compresión",
        "bkp.field_retention": "¿Cuántas conservar?", "bkp.no_delete": "Conservar todas",
        "bkp.field_schedule": "Frecuencia", "bkp.opt_daily": "Diaria", "bkp.opt_weekly": "Semanal",
        "bkp.opt_monthly": "Mensual", "bkp.opt_hourly": "Cada hora",
        "bkp.field_time": "Hora", "bkp.field_weekday": "Día semanal", "bkp.field_monthday": "Día mensual",
        "bkp.day_prefix": "Día ", "bkp.field_notes": "Notas",
        "bkp.btn_create_auto": "Crear automatización",
        "bkp.mon": "Lunes", "bkp.tue": "Martes", "bkp.wed": "Miércoles", "bkp.thu": "Jueves",
        "bkp.fri": "Viernes", "bkp.sat": "Sábado", "bkp.sun": "Domingo",
        "bkp.rules_title": "Reglas aplicadas",
        "bkp.rules_full": "se puede programar siempre.", "bkp.rules_inc": "necesita una copia anterior válida de la misma base de datos.",
        "bkp.rules_diff": "necesita una copia completa previa de la misma base de datos.",
        "bkp.log_title": "Registro de copias automáticas", "bkp.log_desc": "Las copias automáticas guardan su resultado en:",
        "bkp.auto_list_title": "Automatizaciones activas",
        "bkp.th_type": "Tipo", "bkp.th_freq": "Frecuencia", "bkp.th_dest": "Destino",
        "bkp.th_created_by": "Creada por", "bkp.th_actions": "Acciones",
        "bkp.no_autos": "Todavía no has programado ninguna copia automática.",
        "bkp.tag_full": "Completo", "bkp.tag_inc": "Incremental", "bkp.tag_diff": "Diferencial",
        "bkp.opt_full": "Completa", "bkp.opt_inc": "Incremental", "bkp.opt_diff": "Diferencial",
        "bkp.hist_title": "Historial de copias", "bkp.hist_desc": "Últimas copias completas, incrementales y diferenciales registradas",
        "bkp.th_date": "Fecha", "bkp.th_file": "Archivo", "bkp.th_base": "Base", "bkp.th_binlog": "Cambios incluidos",
        "bkp.btn_download": "Descargar", "bkp.btn_restore": "Restaurar", "bkp.btn_delete": "Eliminar",
        "bkp.no_history": "No hay copias registradas todavía.",
        "bkp.modal_full_title": "Copia completa", "bkp.modal_full_sub": "La más segura — ideal para empezar o antes de cambios importantes",
        "bkp.modal_inc_title": "Copia incremental", "bkp.modal_inc_sub": "Solo los cambios desde la última copia guardada",
        "bkp.modal_inc_callout": "incluye solo los cambios desde la última copia guardada.",
        "bkp.modal_diff_title": "Copia diferencial", "bkp.modal_diff_sub": "Cambios acumulados desde la última copia completa",
        "bkp.field_filename": "Nombre del archivo", "bkp.field_notes_opt": "Notas (opcional)",
        "bkp.field_ref": "Base de referencia", "bkp.opt_latest": "Último backup disponible", "bkp.opt_manual": "Manual",
        "bkp.field_ref_diff": "Referencia", "bkp.opt_last_full": "Último backup completo",
        "bkp.btn_cancel": "Cancelar", "bkp.btn_run": "Ejecutar ahora",
        "bkp.restore_title": "Confirmar restauración", "bkp.restore_sub": "La base de datos volverá al estado guardado en ese punto.",
        "bkp.restore_warn_bold": "Atención:", "bkp.restore_warn_pre": "esta operación modificará la base de datos",
        "bkp.restore_warn_post": ". Como precaución, el sistema hará una copia del estado actual antes de empezar.",
        "bkp.restore_chain_pre": "Para restaurar la copia ID", "bkp.restore_chain_post": "se aplicará esta cadena:",
        "bkp.restore_no_chain": "Esta restauración solo necesita aplicar la copia completa seleccionada.",
        "bkp.th_order": "Orden", "bkp.btn_restore_confirm": "Restaurar backup",
        "bkp.delete_title": "Confirmar eliminación",
        "bkp.delete_has_deps": "Esta copia tiene dependencias. Se eliminará la cadena completa.",
        "bkp.delete_no_deps": "Esta copia no tiene dependencias y se puede eliminar de forma individual.",
        "bkp.delete_warn_bold": "Atención:", "bkp.delete_warn_pre": "si eliminas la copia ID",
        ...
        "svc.empty": "No se pudo conectar al servidor para cargar los servicios. Revisa que la conexión esté activa.",
        # alertas.html
        "alr.sidebar_title": "Estado del módulo", "alr.sidebar_ch": "Canal listo",
        "alr.sidebar_rules": "Reglas activas", "alr.sidebar_hist": "Historial disponible",
        "alr.sidebar_multi": "Soporte multiempresa",
        "alr.msg_ok": "¡Listo! Los cambios se han guardado.", "alr.msg_error": "Algo fue mal al guardar. Inténtalo de nuevo.",
        "alr.page_title": "Alertas y avisos",
        "alr.page_subtitle": "Define quién recibe avisos y cuándo. Nosotros nos encargamos del resto.",
        "alr.btn_proactive": "Notificaciones automáticas",
        "alr.stat_total": "Eventos totales", "alr.stat_total_sub": "Total de eventos registrados",
        "alr.stat_ok": "Entregas correctas", "alr.stat_ok_sub": "Mensajes enviados correctamente",
        "alr.stat_error": "Entregas con error", "alr.stat_error_sub": "Revisa la configuración de Telegram",
        "alr.ch_title": "Canal Telegram", "alr.ch_desc": "Estado general del canal y prueba manual.",
        "alr.kv_channel": "Canal", "alr.kv_status": "Estado", "alr.kv_dest": "Destino por defecto",
        "alr.kv_last": "Última entrega", "alr.no_dest": "Sin destino todavía", "alr.no_data": "Sin datos",
        "alr.badge_active": "Activo", "alr.badge_inactive": "Inactivo",
        "alr.btn_disable": "Desactivar canal", "alr.btn_enable": "Activar canal",
        "alr.btn_test": "Enviar prueba al destino por defecto",
        "alr.chatid_title": "Obtener tu Chat ID",
        "alr.chatid_desc": "Escribe <code>/chatid</code> a <strong>@VigexPanelBot</strong> en Telegram — el bot responde con tu ID en segundos.",
        "alr.btn_open_bot": "Abrir @VigexPanelBot", "alr.btn_detect": "Detectar chats recientes",
        "alr.th_username": "Username / nombre", "alr.th_type": "Tipo", "alr.th_action": "Acción",
        "alr.badge_group": "Grupo", "alr.badge_user": "Usuario",
        "alr.btn_add": "Añadir",
        "alr.detect_empty": "Escribe <code>/chatid</code> a @VigexPanelBot en Telegram y pulsa \"Detectar chats recientes\".",
        "alr.recip_title": "Destinatarios Telegram",
        "alr.recip_desc": "Añade usuarios o grupos manualmente, o desde la detección automática.",
        "alr.recip_info": "<strong>Sin configuración extra:</strong> el bot <strong>@VigexPanelBot</strong> es gestionado por Vigex. Solo necesitas tu <code>TELEGRAM_CHAT_ID</code> — obtenlo escribiendo <code>/chatid</code> al bot. Cada empresa recibe únicamente sus propias alertas.",
        "alr.field_company": "Empresa", "alr.field_name": "Nombre visible",
        "alr.field_type": "Tipo", "alr.field_chatid": "Chat ID",
        "alr.opt_user": "Usuario individual", "alr.opt_group": "Grupo",
        "alr.btn_save_recip": "Guardar destinatario", "alr.btn_get_chatid": "Obtener Chat ID",
        "alr.th_company": "Empresa", "alr.th_name": "Nombre", "alr.th_uname": "Username",
        "alr.th_dest": "Destino", "alr.th_default": "Default", "alr.th_actions": "Acciones",
        "alr.badge_yes": "Sí", "alr.badge_no": "No",
        "alr.badge_rule_on": "Activa", "alr.badge_rule_off": "Inactiva",
        "alr.btn_default": "Por defecto", "alr.btn_toggle": "Activar/desactivar", "alr.btn_delete": "Eliminar",
        "alr.confirm_delete": "¿Eliminar destinatario?",
        "alr.no_recip": "No hay destinatarios guardados todavía.",
        "alr.rules_title": "Reglas activas", "alr.rules_desc": "Decide qué eventos generan avisos.",
        "alr.th_event": "Evento", "alr.th_severity": "Severidad", "alr.th_status": "Estado",
        "alr.btn_change": "Cambiar", "alr.no_rules": "No hay reglas configuradas.",
        "alr.guide_title": "Cómo activar las alertas Telegram",
        "alr.guide_desc": "Tres pasos — sin crear bots ni tokens propios.",
        "alr.guide_1": "Abre Telegram y busca <strong>@VigexPanelBot</strong>.",
        "alr.guide_2": "Escríbele <code>/chatid</code> — el bot responde con tu número de Chat ID.",
        "alr.guide_3": "Pega ese número como destinatario en esta página y haz una prueba.",
        "alr.deliv_title": "Últimas entregas", "alr.deliv_desc": "Historial reciente de envíos realizados por el sistema.",
        "alr.th_date": "Fecha", "alr.th_title": "Título",
        "alr.no_deliv": "Aún no hay entregas registradas.",
        # terminal.html
        "term.sidebar_machine": "Máquina", "term.sidebar_hint": "Elige una máquina para empezar",
        "term.page_title": "Terminal remota",
        "term.page_subtitle": "Elige la máquina y ejecuta lo que necesites, directamente desde el navegador.",
        "term.ready": "Vigex Terminal preparada.",
        "term.machine_sel": "Máquina seleccionada:",
        "term.hint": "Escribe un comando y pulsa Enter.",
        "term.mode_label": "Modo:",
        "term.btn_run": "Ejecutar",
        "term.quick_failed": "servicios fallidos", "term.quick_ifaces": "interfaces",
        "term.warning": "Recuerda: estos comandos son reales y se ejecutan en el servidor. Los que tarden más del tiempo límite se cortarán automáticamente.",
        "term.select_title": "Selecciona una máquina",
        ...
        "rec.aviso": "Esta guía te lleva paso a paso por la recuperación del sistema. Sigue el orden. El <strong>paso 3 (restauración)</strong> es irreversible — asegúrate de haber verificado la copia antes de ejecutarlo.",
        "rec.steps_title": "Guía de recuperación — 6 pasos",
        ...
        "rec.sidebar_steps": "Pasos de la guía", "rec.sidebar_disk": "Disco usado",
        # cumplimiento.html
        "cum.page_title": "Cumplimiento NIS2 / ENS / ISO 27001",
        "cum.page_subtitle": "Evidencias técnicas automáticas por control normativo · Catálogo v1.0",
        "cum.aviso": "<strong>Importante:</strong> este módulo muestra la evidencia técnica que Vigex genera automáticamente. <strong>No certifica cumplimiento normativo</strong> — eso requiere una auditoría formal por un organismo acreditado. Valida este informe contra la normativa real antes de presentarlo a un auditor.",
        "cum.btn_collect": "Recoger evidencias ahora", "cum.btn_incidents": "Incidentes NIS2",
        "cum.loading": "Cargando…",
        "cum.legend_full": "Completa", "cum.legend_partial": "Parcial", "cum.legend_none": "No cubierta",
        "cum.js_fresh": "Fresca", "cum.js_expired_badge": "Caducada",
        "cum.js_noev": "Sin evidencia", "cum.js_nocol": "Sin colector",
        "cum.js_last_run": "Última recolección: ", "cum.js_no_ev_yet": "Sin evidencias recogidas todavía",
        "cum.js_fresh_card": "Evidencias frescas", "cum.js_fresh_of_col": " familias con colector",
        "cum.js_expired_card": "Caducadas", "cum.js_pending_suf": " sin recoger todavía",
        "cum.js_attention": "Atención:", "cum.js_ev_exp_in": "evidencia caducada en",
        "cum.js_no_ev_in": "sin evidencia en",
        "cum.js_banner_tail": ". Pulsa \"Recoger evidencias ahora\" para actualizar.",
        "cum.js_all": "Todas", "cum.js_ev_title": "Última evidencia recogida",
        "cum.js_no_filter": "Sin controles para este filtro",
        "cum.js_generating": "Generando…", "cum.js_collecting": "Recogiendo…",
        "cum.js_collect_btn": "Recoger evidencias ahora", "cum.js_net_err": "Error de red",
        "cum.js_load_err": "Error al cargar",
        # ── incidentes.html (R-095) ──
        "inc.page_title": "Incidentes NIS2 — Ciclo de vida",
        "inc.page_subtitle": "Plazos de notificación Art. 23 NIS2 · INCIBE-CERT (empresas) / CCN-CERT (AA.PP.)",
        "inc.info": "<strong>NIS2 Art. 23:</strong> las entidades esenciales e importantes deben notificar incidentes significativos al CSIRT en <strong>≤ 24 h</strong> (aviso temprano) y <strong>≤ 72 h</strong> (notificación completa) desde que tengan conocimiento del incidente. Usa los botones de plantilla para descargar el documento preformateado.",
        "inc.btn_new": "Registrar incidente", "inc.btn_export": "Exportar registro",
        "inc.btn_back": "Volver a Cumplimiento", "inc.loading": "Cargando…",
        "inc.modal_title": "Registrar nuevo incidente",
        "inc.lbl_titulo": "Título *", "inc.lbl_desc": "Descripción *",
        "inc.lbl_tipo": "Tipo *", "inc.lbl_sev": "Severidad *",
        "inc.lbl_detected": "Momento de detección (cuándo tomaste conocimiento) *",
        "inc.lbl_sistemas": "Sistemas / servicios afectados",
        "inc.lbl_medidas": "Medidas inmediatas adoptadas",
        "inc.ph_titulo": "Ej: Acceso no autorizado a servidor de logs",
        "inc.ph_desc": "Describe qué ocurrió, cómo se detectó y cuál es el impacto conocido…",
        "inc.ph_select": "Seleccionar…", "inc.ph_sistemas": "Ej: Servidor de backups, panel Vigex",
        "inc.ph_medidas": "Ej: Aislamiento de servidor, cambio de credenciales, notificación interna…",
        "inc.btn_cancel": "Cancelar", "inc.btn_submit": "Registrar",
        "inc.js_est_detectado": "Detectado", "inc.js_est_24h": "Aviso 24 h enviado",
        "inc.js_est_72h": "Notificación 72 h enviada", "inc.js_est_resuelto": "Resuelto",
        "inc.js_est_cerrado": "Cerrado", "inc.js_trans_24h": "Marcar aviso 24 h enviado",
        "inc.js_trans_72h": "Marcar notif. 72 h enviada", "inc.js_trans_resuelto": "Marcar como resuelto",
        "inc.js_trans_cerrado": "Cerrar incidente", "inc.js_vencido": "Vencido",
        "inc.js_dias": " días ", "inc.js_horas": " h ", "inc.js_min": " min",
        "inc.js_plazo_24": "Aviso 24 h", "inc.js_plazo_72": "Notif. 72 h",
        "inc.js_plazo_det": "Detectado hace",
        "inc.js_enviado": "✅ Enviado", "inc.js_vencido_24": "⚠️ Vencido",
        "inc.js_enviada": "✅ Enviada", "inc.js_vencida_72": "⚠️ Vencida",
        "inc.js_resta": "Resta", "inc.js_kv_tipo": "Tipo", "inc.js_kv_sev": "Severidad",
        "inc.js_kv_creado": "Creado por", "inc.js_kv_csirt": "Ref. CSIRT",
        "inc.js_kv_resuelto": "Resuelto", "inc.js_sist_afect": "Sistemas afectados:",
        "inc.js_medidas": "Medidas adoptadas:", "inc.js_tmpl_24": "Plantilla 24 h",
        "inc.js_tmpl_72": "Plantilla 72 h",
        "inc.js_confirm_pre": "¿Confirmas el avance de estado a \"",
        "inc.js_confirm_suf": "\"?",
        "inc.js_no_inc": "Sin incidentes registrados", "inc.js_load_err": "Error al cargar",
        "inc.js_generating": "Generando…", "inc.js_export_btn": "Exportar registro",
        "inc.js_net_err": "Error de red",
        # ── configuracion.html ──
        "cfg.page_title": "Configuración del panel",
        "cfg.page_subtitle": "Ajusta los parámetros operativos sin necesidad de editar config.env a mano.",
        "cfg.btn_notif": "Ver notificaciones",
        "cfg.banner_off": "Las alertas automáticas están <strong>desactivadas</strong>. Los valores que configures aquí se guardan, pero no se enviarán alertas hasta que actives <code>NOTIF_ENABLED=true</code> en <code>config.env</code> y reinicies el panel.",
        "cfg.sec_thresholds": "Notificaciones proactivas — umbrales",
        "cfg.card_params_title": "Parámetros operativos",
        "cfg.card_params_desc": "Los cambios se aplican al instante, sin reiniciar el panel. También se guardan en el archivo de configuración para que no se pierdan.",
        "cfg.lbl_disk": "Umbral de disco", "cfg.unit_disk": "% de uso de disco (50 – 99)",
        "cfg.hint_disk": "Se envía alerta cuando el disco supera este porcentaje.",
        "cfg.lbl_interval": "Intervalo entre checks",
        "cfg.unit_interval_pre": "segundos (60 – 86 400) · ahora: ", "cfg.unit_interval_suf": " min",
        "cfg.hint_interval": "Cada cuánto comprueba el panel disco, backup y servicios.",
        "cfg.lbl_cooldown": "Silencio entre alertas iguales",
        "cfg.unit_cooldown_pre": "segundos (300 – 86 400) · ahora: ", "cfg.unit_cooldown_suf": " h",
        "cfg.hint_cooldown": "Tiempo mínimo entre dos alertas del mismo tipo para no saturar el canal.",
        "cfg.btn_save": "Guardar cambios",
        "cfg.sec_smtp": "Correo electrónico — SMTP",
        "cfg.card_smtp_title": "Configuración de correo saliente",
        "cfg.card_smtp_desc": "Usado para alertas, informes periódicos y notificaciones a <strong>soporte@vigex.es</strong>. Compatible con Gmail, Outlook u otro SMTP con STARTTLS.",
        "cfg.lbl_provider": "Proveedor de correo", "cfg.opt_provider_default": "— Selecciona tu proveedor —",
        "cfg.lbl_smtp_host": "Servidor SMTP", "cfg.hint_smtp_host": "Rellenado automáticamente al elegir proveedor, o escríbelo tú.",
        "cfg.lbl_smtp_port": "Puerto", "cfg.hint_smtp_port": "587 (STARTTLS) · rellenado automáticamente.",
        "cfg.lbl_smtp_user": "Tu dirección de email", "cfg.hint_smtp_user": "La cuenta que envía los emails (ej: tu@gmail.com).",
        "cfg.lbl_smtp_pass": "Contraseña", "cfg.pill_configured": "Configurada",
        "cfg.ph_pass_nochange": "Dejar vacío para no cambiar", "cfg.ph_pass_new": "Contraseña (o contraseña de app)",
        "cfg.hint_pass_nochange": "Dejar vacío si no quieres cambiarla.", "cfg.hint_pass_new": "Introduce tu contraseña o contraseña de aplicación.",
        "cfg.lbl_email_from": "Remitente (FROM)", "cfg.hint_email_from": "Normalmente igual que tu dirección de email.",
        "cfg.lbl_email_to": "Destinatario de alertas", "cfg.hint_email_to": "¿A quién le llegan las alertas e informes?",
        "cfg.btn_save_smtp": "Guardar configuración email",
        "cfg.sec_session": "Seguridad de sesión", "cfg.card_logout_title": "Auto-logout por inactividad",
        "cfg.card_logout_desc": "Si el usuario no interactúa durante este tiempo, la sesión se cierra automáticamente. Pon 0 para desactivarlo.",
        "cfg.lbl_autologout": "Tiempo de inactividad (minutos)", "cfg.hint_autologout": "0 = desactivado · máximo 1440 (24 h)",
        "cfg.btn_save_short": "Guardar",
        "cfg.sec_readonly": "Configuración de conexiones (solo lectura)",
        "cfg.card_creds_title": "Credenciales y hosts",
        "cfg.card_creds_desc": "Estos valores se cambian editando <code>config.env</code> y reiniciando el panel.",
        "cfg.ro_telegram": "Canal Telegram", "cfg.pill_ok_telegram": "Configurado",
        "cfg.pill_off": "Sin configurar", "cfg.ro_smtp": "Correo SMTP",
        "cfg.ro_ssh_key": "Clave de conexión segura", "cfg.ro_ssh_timeout": "Tiempo de espera",
        "cfg.ro_notif": "Notificaciones activas", "cfg.pill_notif_on": "Activadas", "cfg.pill_notif_off": "Desactivadas",
        "cfg.sidebar_module": "Configuración", "cfg.sidebar_threshold": "Umbral disco", "cfg.sidebar_interval": "Check cada",
        "cfg.js_validation_nums": "Todos los campos deben ser números enteros.",
        "cfg.js_saving": "Guardando…", "cfg.js_saved": "Guardado.", "cfg.js_save_err": "Error al guardar.",
        "cfg.js_net_err": "Error de red. Comprueba la conexión con el panel.",
        "cfg.js_smtp_host_req": "El servidor SMTP es obligatorio.",
        "cfg.js_smtp_err": "Error.", "cfg.js_net_err_short": "Error de red.",
        "cfg.js_logout_range": "Valor entre 0 y 1440 minutos.",
        "cfg.js_btn_save": "Guardar cambios", "cfg.js_btn_save_smtp": "Guardar configuración email",
        # ── informes.html ──
        "inf.page_title": "Informes periódicos",
        "inf.page_subtitle": "El panel genera y envía resúmenes de estado de forma automática. Sin entrar al panel.",
        "inf.last_send_pre": "Último envío: ",
        "inf.banner_no_channel": "No tienes ningún canal de envío activo. Para recibir informes, configura el correo o Telegram en la sección <strong>Configuración</strong>.",
        "inf.sec_config": "Configuración",
        "inf.card_plan_title": "Planificación de informes",
        "inf.card_plan_desc": "Elige con qué frecuencia, por qué canal y qué incluir en cada informe.",
        "inf.slbl_estado": "Estado", "inf.slbl_freq": "Frecuencia",
        "inf.slbl_canal": "Canal", "inf.slbl_next": "Próximo envío en",
        "inf.st_active": "Activos", "inf.st_off": "Desactivados",
        "inf.toggle_label": "Activar informes automáticos",
        "inf.toggle_hint": "El panel enviará el informe según la frecuencia elegida.",
        "inf.lbl_freq": "Frecuencia",
        "inf.opt_diario": "Diario", "inf.opt_semanal": "Semanal", "inf.opt_mensual": "Mensual",
        "inf.lbl_canal": "Canal de envío", "inf.opt_email_noconfig": " (sin configurar)",
        "inf.opt_both": "Email + Telegram",
        "inf.sec_backups": "Copias de seguridad", "inf.sec_disco": "Disco",
        "inf.sec_servicios": "Servicios", "inf.sec_alertas": "Alertas",
        "inf.lbl_content": "Contenido del informe",
        "inf.hint_min_sec": "Al menos una sección debe estar seleccionada.",
        "inf.btn_save": "Guardar configuración", "inf.btn_send": "Enviar informe ahora",
        "inf.sec_history": "Historial de envíos",
        "inf.card_hist_title": "Últimos informes enviados",
        "inf.card_hist_desc_pre": "Se conservan los últimos ",
        "inf.card_hist_desc_suf": " registros de esta sesión.",
        "inf.th_date": "Fecha", "inf.th_canal": "Canal", "inf.th_status": "Estado",
        "inf.pill_sent": "Enviado", "inf.pill_err": "Error",
        "inf.no_history": "Aún no se ha enviado ningún informe. Usa el botón <strong>\"Enviar informe ahora\"</strong> para hacer una prueba.",
        "inf.sidebar_module": "Informes", "inf.sidebar_status": "Estado", "inf.sidebar_freq": "Frecuencia",
        "inf.js_min_sec": "Selecciona al menos una sección para el informe.",
        "inf.js_saving": "Guardando…", "inf.js_btn_save": "Guardar configuración",
        "inf.js_net_err": "Error de red.",
        "inf.js_sending": "Enviando…", "inf.js_btn_send": "Enviar informe ahora",
        # ── admin_users.html ──
        "usr.page_title": "Administración de usuarios",
        "usr.sidebar_title": "Control", "usr.sidebar_total": "Total usuarios: ",
        "usr.sidebar_admin": "Admin protegido", "usr.sidebar_perms": "Permisos delegables: ",
        "usr.title": "Usuarios y permisos",
        "usr.subtitle": "Dale acceso a tu equipo y decide qué puede ver o gestionar cada persona.",
        "usr.btn_logs": "Historial de accesos", "usr.role_admin": "Administrador",
        "usr.kpi_total": "Usuarios totales", "usr.kpi_perms": "Permisos disponibles",
        "usr.kpi_protected": "Cuenta protegida",
        "usr.card_create_title": "Crear nuevo usuario",
        "usr.lbl_username": "Usuario", "usr.ph_username": "Ej: tecnico1",
        "usr.lbl_password": "Contraseña", "usr.ph_password": "Contraseña del usuario",
        "usr.perms_label": "Permisos del panel", "usr.btn_create": "Crear usuario",
        "usr.card_list_title": "Usuarios creados", "usr.card_list_desc": "Listado actual del sistema.",
        "usr.th_user": "Usuario", "usr.th_perms": "Permisos", "usr.th_actions": "Acciones",
        "usr.admin_perms": "Todos", "usr.admin_not_del": "No eliminable",
        "usr.no_perms": "Sin permisos", "usr.btn_delete": "Eliminar",
        "usr.no_users": "Todavía no hay usuarios creados.",
        # ── admin_login_logs.html ──
        "log.page_title": "Historial de accesos",
        "log.sidebar_title": "Auditoría", "log.sidebar_records": "Registros: ",
        "log.sidebar_logins": "Entradas: ", "log.sidebar_logouts": "Salidas: ", "log.sidebar_last": "Último: ",
        "log.title": "Historial de accesos al panel",
        "log.subtitle": "Registro de quién ha entrado al panel, cuándo y desde dónde.",
        "log.btn_back": "Volver a Administración", "log.role_pill": "Solo admin",
        "log.kpi_shown": "Registros mostrados", "log.kpi_ok": "Correctos", "log.kpi_failed": "Fallidos",
        "log.card_title": "Accesos al panel",
        "log.card_desc": "Entradas correctas, intentos fallidos y cierres de sesión de todos los usuarios.",
        "log.th_date": "Fecha", "log.th_action": "Acción", "log.th_result": "Resultado",
        "log.th_user": "Usuario", "log.th_role": "Rol", "log.th_ip": "IP origen",
        "log.th_ua": "Navegador / Cliente", "log.th_detail": "Detalle",
        "log.no_logs": "Todavía no hay logs de inicio o cierre de sesión.",
        # login
        "lgn.page_title": "Acceso", "lgn.subtitle": "Accede a tu panel de gestión",
        "lgn.error_blocked_title": "Acceso bloqueado temporalmente.",
        "lgn.error_blocked_msg": "Demasiados intentos fallidos. Espera unos minutos antes de volver a intentarlo.",
        "lgn.error_creds": "Usuario o contraseña incorrectos. Comprueba tus credenciales.",
        "lgn.lbl_username": "Usuario", "lgn.ph_username": "Tu nombre de usuario",
        "lgn.lbl_password": "Contraseña", "lgn.ph_password": "Tu contraseña",
        "lgn.btn_enter": "Entrar al panel",
        "lgn.footer": "Vigex · Acceso restringido al personal autorizado",
        # soporte principal
        "sop.page_title": "Soporte", "sop.title": "Soporte Vigex",
        "sop.subtitle": "¿Tienes algún problema o duda? Cuéntanoslo aquí y te ayudamos.",
        "sop.btn_tickets": "Gestionar tickets",
        "sop.ok_registered": "Tu solicitud ha llegado correctamente.",
        "sop.ok_ref": "Referencia interna:", "sop.ok_see": "Ver estado",
        "sop.err_save": "No pudimos guardar la solicitud. Inténtalo de nuevo.",
        "sop.card_new": "Nueva solicitud",
        "sop.lbl_empresa": "Empresa *", "sop.lbl_contacto": "Persona de contacto *",
        "sop.lbl_email": "Email *", "sop.lbl_telefono": "Teléfono",
        "sop.lbl_tipo": "Tipo de solicitud", "sop.lbl_prioridad": "Prioridad percibida",
        "sop.lbl_servicio": "Servicio afectado", "sop.lbl_desc": "Descripción *",
        "sop.ph_desc": "Explica qué ocurre, desde cuándo y qué impacto tiene.",
        "sop.lbl_evidencia": "Evidencia opcional",
        "sop.ph_evidencia": "Pega aquí texto de error, enlaces internos o notas de captura.",
        "sop.btn_create": "Crear ticket",
        "sop.card_last": "Últimas solicitudes",
        "sop.card_last_desc": "Seguimiento básico de solicitudes registradas en este panel.",
        "sop.ticket_see": "Ver estado",
        "sop.no_tickets": "No hay tickets registrados todavía.",
        # soporte_tickets
        "tic.page_title": "Tickets de soporte",
        "tic.title_soporte": "Tickets de soporte", "tic.sub_soporte": "Vista interna para el equipo Vigex.",
        "tic.title_reportes": "Reportes del panel",
        "tic.sub_reportes": "Bugs, sugerencias y preguntas enviadas desde el botón de reporte.",
        "tic.btn_ver_tickets": "Ver tickets", "tic.btn_nuevo": "Nuevo ticket",
        "tic.btn_reportes": "Ver reportes", "tic.btn_sync": "Sincronización",
        "tic.kpi_total": "Total tickets", "tic.kpi_open": "Abiertos",
        "tic.kpi_closed": "Cerrados", "tic.kpi_central": "Pendientes de envío",
        "tic.filter_estado": "Estado", "tic.filter_todos": "Todos", "tic.filter_todas": "Todas",
        "tic.filter_prioridad": "Prioridad", "tic.filter_tipo": "Tipo", "tic.filter_q": "Búsqueda",
        "tic.filter_ph_q": "ID, cliente, email, servicio...",
        "tic.btn_filter": "Filtrar", "tic.btn_retry": "Reintentar envío central pendiente",
        "tic.th_id": "ID", "tic.th_central": "CENTRAL", "tic.th_cliente": "Cliente",
        "tic.th_tipo": "Tipo", "tic.th_prioridad": "Prioridad", "tic.th_estado": "Estado",
        "tic.th_servicio": "Servicio", "tic.th_fecha": "Fecha", "tic.sin_central": "Sin central",
        "tic.no_tickets": "No hay tickets que coincidan con los filtros seleccionados.",
        # soporte_ticket_detalle
        "tdt.page_title": "Detalle ticket", "tdt.btn_back": "Volver a tickets",
        "tdt.btn_new": "Nuevo ticket",
        "tdt.ok_updated": "Ticket actualizado correctamente.",
        "tdt.err_update": "No se pudo actualizar el ticket.",
        "tdt.card_info": "Información del ticket",
        "tdt.lbl_cliente": "Cliente", "tdt.lbl_contacto": "Contacto",
        "tdt.lbl_email": "Email", "tdt.lbl_telefono": "Teléfono",
        "tdt.lbl_servicio": "Servicio", "tdt.lbl_canal": "Canal",
        "tdt.lbl_fecha": "Fecha apertura", "tdt.lbl_creado": "Creado por",
        "tdt.card_estado": "Actualizar estado y prioridad",
        "tdt.nota_obligatoria": "La nota es <strong>obligatoria</strong> — quedará en el historial del ticket.",
        "tdt.lbl_estado": "Estado", "tdt.lbl_prioridad": "Prioridad",
        "tdt.ph_nota": "Escribe aquí el motivo del cambio, la respuesta al cliente o las acciones tomadas…",
        "tdt.lbl_nota": "Nota / Respuesta al cliente",
        "tdt.btn_guardar": "Guardar cambios",
        "tdt.card_desc": "Descripción", "tdt.card_evidencia": "Evidencia",
        "tdt.evidencia_vacia": "Sin evidencia registrada.",
        "tdt.card_jira": "Exportar a gestor externo",
        "tdt.jira_desc": "Texto preparado para copiar en otra herramienta de gestión (Jira, Zammad, etc.).",
        "tdt.btn_copy_jira": "Copiar texto",
        "tdt.card_plantillas": "Plantillas de respuesta",
        "tdt.plantillas_desc": "Selecciona una respuesta tipo para copiarla y enviarla al cliente.",
        "tdt.lbl_plantilla": "Plantilla", "tdt.opt_plantilla": "Seleccionar plantilla",
        "tdt.lbl_uso": "Uso recomendado", "tdt.uso_default": "Selecciona una plantilla para ver su uso.",
        "tdt.btn_generar": "Generar respuesta", "tdt.h_respuesta": "Respuesta generada",
        "tdt.btn_copy_resp": "Copiar respuesta",
        "tdt.card_historial": "Historial interno",
        "tdt.no_historial": "No hay cambios registrados todavía.",
        "tdt.card_sync": "Sincronización central",
        "tdt.btn_sync_central": "Sincronizar estado desde central",
        "tdt.lbl_ticket_central": "Ticket central", "tdt.sin_central": "Sin referencia central",
        "tdt.lbl_sync_status": "Estado sincronización", "tdt.no_sync": "No sincronizado",
        "tdt.lbl_sync_at": "Última sincronización", "tdt.lbl_sync_detail": "Detalle sincronización",
        # soporte_sincronizacion
        "sin.page_title": "Sincronización soporte",
        "sin.sidebar_title": "Sincronización", "sin.sidebar_total": "Total: ",
        "sin.sidebar_sent": "Enviados: ", "sin.sidebar_pending": "Pendientes: ",
        "sin.sidebar_disabled": "Desactivados: ",
        "sin.title": "Estado de envío al soporte central",
        "sin.subtitle": "¿Llegaron tus solicitudes al panel central Vigex?",
        "sin.btn_tickets": "Tickets", "sin.btn_retry": "Reintentar pendientes",
        "sin.kpi_total": "Total local", "sin.kpi_sent": "Enviados",
        "sin.kpi_pending": "Con problema", "sin.kpi_disabled": "Desactivados",
        "sin.kpi_nocentral": "Sin central",
        "sin.th_local": "Ticket local", "sin.th_cliente": "Cliente",
        "sin.th_central_state": "Estado central", "sin.th_central_ticket": "Ticket central",
        "sin.th_sync_at": "Último envío", "sin.th_detail": "Detalle",
        "sin.badge_sent": "Enviado", "sin.badge_error": "Con problema",
        "sin.badge_disabled": "Desactivado", "sin.badge_nocentral": "Sin central",
        "sin.no_tickets": "No hay tickets para el filtro seleccionado.",
        # soporte_ticket_estado_cliente
        "est.btn_back_sop": "Volver a soporte", "est.btn_back_panel": "Volver al panel",
        "est.tracking_sub": "Seguimiento de la solicitud registrada en el panel Vigex.",
        "est.last_update": "Última actualización:",
        "est.card_datos": "Datos de la solicitud",
        "est.lbl_empresa": "Empresa", "est.lbl_contacto": "Persona de contacto",
        "est.lbl_email": "Email", "est.lbl_telefono": "Teléfono",
        "est.lbl_servicio": "Servicio afectado", "est.lbl_fecha": "Fecha de apertura",
        "est.card_desc": "Descripción enviada", "est.card_evidencia": "Evidencia aportada",
        "est.evidencia_vacia": "Sin evidencia registrada.",
        "est.card_seguimiento": "Seguimiento",
        "est.timeline_registered": "Solicitud registrada",
        "est.timeline_team_recv": "El equipo Vigex ha recibido la solicitud.",
        "est.timeline_current_pre": "Estado actual:",
        "est.pending_notice": "El equipo Vigex necesita información adicional para continuar con la solicitud.",
        "est.card_info": "Información para el cliente",
        "est.info_text": "Esta vista muestra el estado actual de la solicitud. Para añadir información adicional, responde por el canal acordado con el equipo Vigex indicando la referencia",
        "est.info_muted": "La gestión técnica interna, plantillas de respuesta y sincronización central están reservadas al equipo Vigex.",
        # soporte_faq
        "faq.page_title": "Preguntas frecuentes", "faq.title": "Preguntas frecuentes",
        "faq.subtitle": "Encuentra respuesta rápida a los problemas más habituales de Vigex.",
        "faq.btn_ticket": "Abrir ticket",
        "faq.ph_search": "Busca por palabras: copia, disco, telegram, conexión…",
        "faq.results_count_pre": "resultado(s) para",
        "faq.see_all": "Ver todas", "faq.count_available": "preguntas disponibles.",
        "faq.no_results_pre": "No se encontraron resultados para \"",
        "faq.no_results_suf": "\".",
        "faq.no_results_link1": "Ver todas las preguntas",
        "faq.no_results_or": "o", "faq.no_results_link2": "abrir un ticket",
        "faq.no_results_suffix": "si no encuentras respuesta.",
        "faq.sidebar_total": "Preguntas", "faq.sidebar_results": "Resultados",
        # asistente
        "ais.page_title": "Asistente IA", "ais.rag_docs": " documentos indexados",
        "ais.btn_clear": "Limpiar",
        "ais.ollama_no_detected": "Ollama no detectado.",
        "ais.ollama_no_model_pre": "Modelo ", "ais.ollama_no_model_suf": " no descargado.",
        "ais.ollama_model_do": "Ejecuta:", "ais.ollama_available": "Modelos disponibles:",
        "ais.ollama_none": "ninguno",
        "ais.empty_h3": "¿En qué puedo ayudarte?",
        "ais.empty_p": "Pregúntame sobre backups, servicios, alertas, logs, monitoreo o recuperación ante desastres.",
        "ais.sug1": "¿Qué hago si una copia de seguridad falló?",
        "ais.sug2": "El disco está al 90%, ¿qué hago?",
        "ais.sug3": "¿Cómo restauro una copia de seguridad?",
        "ais.sug4": "Un servicio aparece como caído, ¿cómo lo reinicio?",
        "ais.sug5": "¿Qué significan las alertas de Vigex?",
        "ais.sug6": "¿Cómo funciona la recuperación ante desastres?",
        "ais.ph_input": "Escribe tu pregunta… (Enter para enviar, Shift+Enter para nueva línea)",
        "ais.hint_model": "Respuestas basadas en la documentación de Vigex · Modelo:",
        "ais.thinking": "Pensando…", "ais.no_resp": "(Sin respuesta)",
        # alertas_proactivas
        "prn.page_title": "Notificaciones proactivas",
        "prn.sidebar_title": "Notificaciones",
        "prn.sidebar_active": "Activas", "prn.sidebar_inactive": "Desactivadas",
        "prn.sidebar_interval": "Intervalo: ", "prn.sidebar_last": "Última: ",
        "prn.sidebar_runs": "Ejecuciones: ",
        "prn.title": "Notificaciones automáticas",
        "prn.subtitle": "El panel vigila el disco, las copias y los servicios, y te avisa antes de que haya un problema.",
        "prn.pill_active": "Vigilando activamente", "prn.pill_inactive": "Desactivadas",
        "prn.btn_back": "Volver a Alertas",
        "prn.notice_disabled": "Las notificaciones proactivas están desactivadas.",
        "prn.notice_hint": "Para activarlas, añade <code>NOTIF_ENABLED=true</code> en <code>config.env</code> y configura el correo en la sección <strong>Configuración</strong>.",
        "prn.check_disk_label": "Uso de disco (/)",
        "prn.check_disk_threshold": "Umbral:", "prn.check_disk_never": "Nunca comprobado",
        "prn.check_backup_label": "Último backup",
        "prn.check_services_label": "Servicios del servidor",
        "prn.check_inactive": "Inactivos:",
        "prn.badge_ok": "OK", "prn.badge_alert": "Alerta", "prn.badge_nodata": "Sin datos",
        "prn.alerts_suf_1": " alerta enviada", "prn.alerts_suf_n": " alertas enviadas",
        "prn.card_config": "Configuración activa",
        "prn.config_desc": "Valores actuales del sistema. Para cambiarlos, usa la sección <strong>Configuración</strong> o edita <code>config.env</code>.",
        "prn.tg_on": "configurado", "prn.tg_off": "sin configurar",
        "prn.cfg_email_to": "Destinatario email", "prn.cfg_smtp": "Servidor SMTP",
        "prn.cfg_threshold": "Umbral de disco", "prn.cfg_interval": "Intervalo entre checks",
        "prn.cfg_cooldown": "Silencio entre alertas",
        "prn.cfg_interval_unit": " minutos", "prn.cfg_cooldown_unit": " horas",
        "prn.cfg_last_run": "Última ejecución", "prn.cfg_never": "Aún no",
        "prn.card_check": "Ejecutar comprobación ahora",
        "prn.check_desc": "Lanza las tres comprobaciones en este momento sin esperar al siguiente ciclo automático. Los resultados aparecerán arriba al recargar.",
        "prn.btn_check": "Comprobar ahora",
        "prn.js_done_pre": "Comprobación ejecutada a las ",
        "prn.js_done_suf": ". Recarga para ver los resultados.",
        "prn.js_error_pre": "Error: ", "prn.js_no_conn": "No se pudo conectar con el servidor.",
        "prn.card_log": "Historial de alertas enviadas",
        "prn.log_desc_pre": "Últimas ", "prn.log_desc_suf": " alertas despachadas en esta sesión del panel.",
        "prn.th_date": "Fecha / hora", "prn.th_type": "Tipo",
        "prn.th_tg": "Telegram", "prn.th_email": "Email",
        "prn.badge_sent": "Enviado", "prn.badge_not_sent": "No enviado",
        "prn.no_alerts": "Sin alertas enviadas en esta sesión. Buena señal. 🎉",
        # copias_salud
        "sal.page_title": "Integridad de copias", "sal.title": "Integridad de copias",
        "sal.subtitle": "Comprueba que tus copias están en buen estado y sin daños.",
        "sal.updated": "Actualizado:", "sal.btn_refresh": "Verificar ahora",
        "sal.btn_back": "Copias",
        "sal.kpi_analyzed": "Copias analizadas",
        "sal.kpi_analyzed_sub": "Últimas 30 entradas del historial",
        "sal.kpi_errors": "Errores detectados",
        "sal.kpi_errors_sub": "Copias con estado distinto de OK",
        "sal.kpi_sha": "Con verificación",
        "sal.kpi_sha_sub_pre": "De ", "sal.kpi_sha_sub_suf": " sin verificar",
        "sal.kpi_tables": "Tablas BD",
        "sal.kpi_tables_noaccess": "Sin acceso",
        "sal.kpi_tables_checked": "Comprobadas automáticamente",
        "sal.ssh_error_pre": "No se pudo leer el historial de copias:",
        "sal.section_backups": "Copias — estado e integridad",
        "sal.card_backup_title": "Verificación de copias",
        "sal.card_backup_desc": "Estado de cada copia registrada en el sistema.",
        "sal.sha_missing_pre": "sin verificar — anteriores a la activación de la comprobación.",
        "sal.th_id": "ID", "sal.th_date": "Fecha", "sal.th_type": "Tipo",
        "sal.th_db": "BD", "sal.th_state": "Estado", "sal.th_sha": "Verificación", "sal.th_size": "Tamaño",
        "sal.no_ssh": "No se pudo conectar al servidor de backups para leer el historial.",
        "sal.no_backups": "Aún no hay copias registradas en el historial.",
        "sal.section_db": "Base de datos de logs",
        "sal.card_db_desc_noaccess": "No se pudo conectar:",
        "sal.card_db_desc_ok": "Comprobación automática de tablas — todo en orden.",
        "sal.no_db": "Sin conexión a la base de datos. Revisa los datos de acceso en la sección <strong>Configuración</strong>.",
        "sal.no_tables": "Sin tablas detectadas.",
        "sal.sidebar_ok": "Copias OK", "sal.sidebar_sha": "Verificadas", "sal.sidebar_tables": "Tablas BD",
        "sal.verifying": "Verificando…",
    },
    "ca": {
        ...
        # index.html — Tauler (Panel)
        "panel.hello_prefix": "Hola, ", "panel.subtitle_ok": "Tot sota control.",
        "panel.system_active": "Sistema actiu", "panel.users_singular": "usuari",
        "panel.checking": "Comprovant…",
        "panel.stat_backup": "Darrera còpia", "panel.stat_services": "Serveis",
        "panel.stat_alerts": "Alertes", "panel.stat_disk": "Disc del servidor",
        "panel.no_data": "Sense dades", "panel.all_active": "Tots actius",
        "panel.inactive_sg": " inactiu", "panel.inactive_pl": " inactius",
        "panel.with_error": " amb error", "panel.no_errors": "Sense errors",
        "panel.disk_full": "Ple", "panel.disk_watch": "Vigilar", "panel.disk_free": "Lliure",
        "panel.disk_of": " de ", "panel.disk_used_suf": " usat",
        "panel.badge_nd": "N/D", "panel.badge_attention": "Atenció", "panel.badge_review": "Revisar",
        "panel.backups_title": "Còpies de seguretat",
        "panel.backups_desc": "Protegeix les teves dades amb un clic. Programa còpies automàtiques i recupera-les quan ho necessitis.",
        "panel.backups_btn": "Obrir còpies", "panel.backups_meta": "Cada còpia verificada automàticament",
        "panel.logs_title": "Registres i auditoria",
        "panel.logs_desc": "Alguna cosa ha fallat? Aquí tens tots els esdeveniments del sistema, ordenats i fàcils de revisar.",
        "panel.logs_btn": "Veure registres", "panel.logs_meta": "Registres guardats de forma segura",
        "panel.servicios_title": "Serveis del sistema",
        "panel.servicios_desc": "Engega, atura o reinicia serveis del servidor sense tocar cap cable. Tot des d'aquí.",
        "panel.servicios_btn": "Gestionar serveis", "panel.servicios_meta": "Connexió xifrada al servidor",
        "panel.terminal_title": "Terminal remota",
        "panel.terminal_desc": "Accés directe al servidor quan el necessites. Ràpid, segur i sense sortir del tauler.",
        "panel.terminal_btn": "Obrir terminal", "panel.terminal_meta": "Només ordres autoritzades",
        "panel.alertas_title": "Alertes",
        "panel.alertas_desc": "Defineix qui rep avís i quan. El sistema t'alerta per Telegram quan alguna cosa necessita la teva atenció.",
        "panel.alertas_btn": "Gestionar alertes", "panel.alertas_meta": "Avisos a l'instant per Telegram",
        "panel.soporte_title": "Suport Vigex",
        "panel.soporte_desc": "Alguna cosa no funciona com esperes? Obre un tiquet i l'equip Vigex se n'encarrega.",
        "panel.soporte_btn": "Obrir suport", "panel.soporte_meta": "Connectat a Vigex Central",
        "panel.admin_title": "Administració",
        "panel.admin_desc": "Dona accés al teu equip i decideix exactament què pot veure o tocar cada persona.",
        "panel.admin_btn1": "Gestionar usuaris", "panel.admin_btn2": "Veure accessos",
        "panel.admin_meta": "Només administrador",
        # monitoreo.html
        "mon.page_title": "Estat del servidor",
        "mon.page_subtitle": "CPU, memòria, disc i activitat en temps real. Sense necessitat d'obrir res més.",
        "mon.server_label": "Servidor", "mon.reads_label": "lectures",
        "mon.autorefresh": "Actualització automàtica cada 30 s",
        "mon.loading": "Carregant…", "mon.connecting": "Connectant…",
        "mon.refresh_btn": "Actualitzar ara",
        "mon.label_load": "Activitat (1 min)", "mon.label_mem": "Memòria RAM",
        "mon.label_disk": "Disc principal", "mon.label_uptime": "Temps actiu",
        "mon.badge_active": "Actiu",
        "mon.chart_title": "Càrrega del sistema — historial d'aquesta sessió",
        "mon.chart_subtitle": "Una lectura cada 30 segons. L'historial s'esborra en sortir de la pàgina.",
        "mon.load_avg_title": "Activitat mitjana del processador",
        "mon.load_avg_desc": "Per sota de 1.0 el servidor va bé. Si puja durant una estona per sobre dels nuclis disponibles, és que té feina acumulada.",
        "mon.load_1min": "1 minut", "mon.load_5min": "5 minuts", "mon.load_15min": "15 minuts",
        "mon.no_data": "Sense dades del servidor",
        "mon.load_sub": "Activitat de l'últim minut",
        "mon.load_high": "Alta", "mon.load_med": "Moderada", "mon.load_ok": "Normal",
        "mon.mem_full": "Plena", "mon.mem_of": " de ", "mon.mem_used_suf": " usada",
        "mon.disk_full": "Ple", "mon.disk_watch": "Vigilar", "mon.disk_free": "Lliure",
        "mon.disk_of": " de ", "mon.disk_used_suf": " usat",
        "mon.reads_sg": " lectura", "mon.reads_pl": " lectures",
        "mon.refresh_in": "Actualitzant en ", "mon.refresh_s": " s", "mon.refreshing": "Actualitzant…",
        "mon.uptime_sub": "Funcionant sense parar des de",
        # logs.html
        "logs.sidebar_title": "Resum ràpid", "logs.events_ok": "Esdeveniments OK",
        "logs.events_error": "Amb error", "logs.last": "Últim",
        "logs.page_title": "Registre d'activitat",
        "logs.page_subtitle": "Tot el que passa al sistema, registrat i llest per revisar quan ho necessitis.",
        "logs.kpi_total": "Esdeveniments carregats", "logs.kpi_ok": "Sense errors", "logs.kpi_errors": "Amb errors",
        "logs.cacti_title": "Monitoratge extern", "logs.cacti_desc": "Accedeix al sistema de gràfiques del teu servidor.",
        "logs.cacti_btn": "Obrir Cacti",
        "logs.table_title": "Esdeveniments de Vigex Web",
        "logs.table_desc": "Darreres 100 entrades del registre d'activitat del tauler.",
        "logs.th_fecha": "Data", "logs.th_origen": "Origen", "logs.th_tipo": "Tipus",
        "logs.th_usuario": "Usuari", "logs.th_recurso": "Què ha passat",
        "logs.th_resultado": "Resultat", "logs.th_detalle": "Detall",
        "logs.empty": "No hi ha entrades per mostrar. Si la vista apareix buida, pot haver-hi un problema amb la connexió al registre.",
        # backups.html
        "bkp.sidebar_title": "Estat del mòdul", "bkp.sidebar_ready": "Llest per crear còpies",
        "bkp.sidebar_inc": "Còpies incrementals disponibles", "bkp.sidebar_access": "Accés controlat",
        "bkp.msg_ok": "Còpia creada correctament!", "bkp.msg_error": "Alguna cosa ha fallat en crear la còpia. Torna-ho a intentar.",
        "bkp.page_title": "Còpies de seguretat",
        "bkp.page_subtitle": "Tria el tipus de còpia que necessites i posa-la en marxa en pocs segons.",
        "bkp.integrity_btn": "Integritat",
        "bkp.create_title": "Crear còpia", "bkp.create_desc": "Tria el tipus de còpia i obre el seu formulari.",
        "bkp.btn_full": "Còpia completa", "bkp.btn_inc": "Còpia incremental", "bkp.btn_diff": "Còpia diferencial",
        "bkp.notes_title": "Notes del producte", "bkp.notes_desc": "Ajudes i explicacions intuïtives per a l'usuari.",
        "bkp.help_full_title": "Completa",
        "bkp.help_full_desc": "Crea una còpia íntegra de la base de dades seleccionada. És l'opció més recomanable per a còpies inicials, proves de restauració i punts de seguretat clars abans de fer canvis importants.",
        "bkp.help_inc_title": "Incremental",
        "bkp.help_inc_desc": "Desa només els canvis des de la darrera còpia. Ocupa molt menys espai i manté una cadena de protecció diària.",
        "bkp.help_diff_title": "Diferencial",
        "bkp.help_diff_desc": "Desa els canvis des de la darrera còpia completa. És el punt mig: més ràpida de restaurar que l'incremental i més lleugera que la completa.",
        "bkp.related_title": "Funcions relacionades", "bkp.related_desc": "Més informació per entendre l'evolució del mòdul de còpies.",
        "bkp.help_sched_title": "Còpies automàtiques i programades",
        "bkp.help_sched_desc": "Permet definir còpies periòdiques per no dependre d'execucions manuals. La idea és que el sistema pugui mantenir una rutina estable de protecció segons la freqüència configurada per l'usuari.",
        "bkp.help_restore_title": "Restauració",
        "bkp.help_restore_desc": "Serà la funció encarregada de recuperar un punt anterior de la base de dades a partir d'una còpia disponible. Està pensada per resoldre errors, pèrdues d'informació o tornar a un estat conegut del sistema.",
        "bkp.help_hist_title": "Historial de còpies",
        "bkp.help_hist_desc": "Mostrarà el registre de còpies realitzades amb la seva data, tipus, resultat i ubicació. D'aquesta manera l'usuari podrà revisar ràpidament què s'ha executat i quin punt de còpia té disponible.",
        "bkp.auto_title": "Programar còpies automàtiques",
        "bkp.auto_desc": "Decideix quan vols que es facin les còpies i oblida-te'n. El sistema s'encarrega.",
        "bkp.callout_warn_bold": "Tingues en compte:",
        "bkp.callout_warn_text": "les còpies incrementals només es poden programar si ja existeix una còpia base d'aquesta base de dades. Les diferencials només si ja n'existeix una de completa.",
        "bkp.field_type": "Tipus de còpia", "bkp.field_db": "Base de dades", "bkp.field_dest": "Carpeta destí",
        "bkp.field_compress": "Compressió", "bkp.no_compress": "Sense compressió",
        "bkp.field_retention": "Quantes conservar?", "bkp.no_delete": "Conservar totes",
        "bkp.field_schedule": "Freqüència", "bkp.opt_daily": "Diària", "bkp.opt_weekly": "Setmanal",
        "bkp.field_time": "Hora", "bkp.field_weekday": "Dia de la setmana", "bkp.field_monthday": "Dia del mes",
        "bkp.day_prefix": "Dia ", "bkp.field_notes": "Notes",
        "bkp.btn_create_auto": "Crear automatització",
        "bkp.mon": "Dilluns", "bkp.tue": "Dimarts", "bkp.wed": "Dimecres", "bkp.thu": "Dijous",
        "bkp.fri": "Divendres", "bkp.sat": "Dissabte", "bkp.sun": "Diumenge",
        "bkp.rules_title": "Regles aplicades",
        "bkp.rules_full": "es pot programar sempre.", "bkp.rules_inc": "necessita una còpia anterior vàlida de la mateixa base de dades.",
        "bkp.rules_diff": "necessita una còpia completa prèvia de la mateixa base de dades.",
        "bkp.log_title": "Registre de còpies automàtiques", "bkp.log_desc": "Les còpies automàtiques desen el seu resultat a:",
        "bkp.auto_list_title": "Automatitzacions actives",
        "bkp.th_type": "Tipus", "bkp.th_freq": "Freqüència", "bkp.th_dest": "Destí",
        "bkp.th_created_by": "Creada per", "bkp.th_actions": "Accions",
        "bkp.no_autos": "Encara no has programat cap còpia automàtica.",
        "bkp.tag_full": "Completa", "bkp.tag_inc": "Incremental", "bkp.tag_diff": "Diferencial",
        "bkp.opt_full": "Completa",
        "bkp.hist_title": "Historial de còpies", "bkp.hist_desc": "Darreres còpies completes, incrementals i diferencials registrades",
        "bkp.th_date": "Data", "bkp.th_file": "Fitxer", "bkp.th_binlog": "Canvis inclosos",
        "bkp.btn_download": "Descarregar", "bkp.btn_restore": "Restaurar", "bkp.btn_delete": "Eliminar",
        "bkp.no_history": "No hi ha còpies registrades encara.",
        "bkp.modal_full_title": "Còpia completa", "bkp.modal_full_sub": "La més segura — ideal per començar o abans de canvis importants",
        "bkp.modal_inc_title": "Còpia incremental", "bkp.modal_inc_sub": "Només els canvis des de la darrera còpia desada",
        "bkp.modal_inc_callout": "inclou només els canvis des de la darrera còpia desada.",
        "bkp.modal_diff_title": "Còpia diferencial", "bkp.modal_diff_sub": "Canvis acumulats des de la darrera còpia completa",
        "bkp.field_filename": "Nom del fitxer", "bkp.field_notes_opt": "Notes (opcional)",
        "bkp.field_ref": "Base de referència", "bkp.opt_latest": "Darrera còpia disponible", "bkp.opt_manual": "Manual",
        "bkp.field_ref_diff": "Referència", "bkp.opt_last_full": "Darrera còpia completa",
        "bkp.btn_cancel": "Cancel·lar", "bkp.btn_run": "Executar ara",
        "bkp.restore_title": "Confirmar restauració", "bkp.restore_sub": "La base de dades tornarà a l'estat desat en aquell punt.",
        "bkp.restore_warn_bold": "Atenció:", "bkp.restore_warn_pre": "aquesta operació modificarà la base de dades",
        "bkp.restore_warn_post": ". Com a precaució, el sistema farà una còpia de l'estat actual abans de començar.",
        "bkp.restore_chain_pre": "Per restaurar la còpia ID", "bkp.restore_chain_post": "s'aplicarà aquesta cadena:",
        "bkp.restore_no_chain": "Aquesta restauració només necessita aplicar la còpia completa seleccionada.",
        "bkp.th_order": "Ordre", "bkp.btn_restore_confirm": "Restaurar còpia",
        "bkp.delete_title": "Confirmar eliminació",
        "bkp.delete_has_deps": "Aquesta còpia té dependències. S'eliminarà la cadena completa.",
        "bkp.delete_no_deps": "Aquesta còpia no té dependències i es pot eliminar de forma individual.",
        "bkp.delete_warn_bold": "Atenció:", "bkp.delete_warn_pre": "si elimines la còpia ID",
        ...
        "svc.empty": "No s'ha pogut connectar al servidor per carregar els serveis. Revisa que la connexió estigui activa.",
        # alertas.html
        "alr.sidebar_title": "Estat del mòdul", "alr.sidebar_ch": "Canal llest",
        "alr.sidebar_multi": "Suport multiempresa",
        "alr.msg_ok": "Fet! Els canvis s'han desat.", "alr.msg_error": "Alguna cosa ha fallat en desar. Torna-ho a intentar.",
        "alr.page_title": "Alertes i avisos",
        "alr.page_subtitle": "Defineix qui rep avisos i quan. Nosaltres ens encarreguem de la resta.",
        "alr.btn_proactive": "Notificacions automàtiques",
        "alr.stat_total": "Esdeveniments totals", "alr.stat_total_sub": "Total d'esdeveniments registrats",
        "alr.stat_ok": "Lliuraments correctes", "alr.stat_ok_sub": "Missatges enviats correctament",
        "alr.stat_error": "Lliuraments amb error", "alr.stat_error_sub": "Revisa la configuració de Telegram",
        "alr.ch_desc": "Estat general del canal i prova manual.",
        "alr.kv_status": "Estat", "alr.kv_dest": "Destí per defecte",
        "alr.kv_last": "Darrer lliurament", "alr.no_dest": "Sense destí encara", "alr.no_data": "Sense dades",
        "alr.badge_active": "Actiu", "alr.badge_inactive": "Inactiu",
        "alr.btn_disable": "Desactivar canal", "alr.btn_enable": "Activar canal",
        "alr.btn_test": "Enviar prova al destí per defecte",
        "alr.chatid_title": "Obtenir el teu Chat ID",
        "alr.chatid_desc": "Escriu <code>/chatid</code> a <strong>@VigexPanelBot</strong> a Telegram — el bot respon amb el teu ID en segons.",
        "alr.btn_open_bot": "Obrir @VigexPanelBot", "alr.btn_detect": "Detectar xats recents",
        "alr.th_username": "Usuari / nom", "alr.th_type": "Tipus", "alr.th_action": "Acció",
        "alr.badge_group": "Grup", "alr.badge_user": "Usuari",
        "alr.btn_add": "Afegir",
        "alr.detect_empty": "Escriu <code>/chatid</code> a @VigexPanelBot a Telegram i prem \"Detectar xats recents\".",
        "alr.recip_title": "Destinataris Telegram",
        "alr.recip_desc": "Afegeix usuaris o grups manualment, o des de la detecció automàtica.",
        "alr.recip_info": "<strong>Sense configuració extra:</strong> el bot <strong>@VigexPanelBot</strong> és gestionat per Vigex. Només necessites el teu <code>TELEGRAM_CHAT_ID</code> — obtén-lo escrivint <code>/chatid</code> al bot. Cada empresa rep únicament les seves pròpies alertes.",
        "alr.field_name": "Nom visible", "alr.opt_user": "Usuari individual",
        "alr.btn_save_recip": "Desar destinatari", "alr.btn_get_chatid": "Obtenir Chat ID",
        "alr.th_name": "Nom", "alr.th_dest": "Destí", "alr.th_default": "Per defecte", "alr.th_actions": "Accions",
        "alr.btn_default": "Per defecte",
        "alr.confirm_delete": "Eliminar destinatari?",
        "alr.no_recip": "No hi ha destinataris desats encara.",
        "alr.rules_title": "Regles actives", "alr.rules_desc": "Decideix quins esdeveniments generen avisos.",
        "alr.th_event": "Esdeveniment", "alr.th_severity": "Severitat", "alr.th_status": "Estat",
        "alr.btn_change": "Canviar", "alr.no_rules": "No hi ha regles configurades.",
        "alr.guide_title": "Com activar les alertes Telegram",
        "alr.guide_desc": "Tres passos — sense crear bots ni tokens propis.",
        "alr.guide_1": "Obre Telegram i cerca <strong>@VigexPanelBot</strong>.",
        "alr.guide_2": "Escriu-li <code>/chatid</code> — el bot respon amb el teu número de Chat ID.",
        "alr.guide_3": "Enganxa aquest número com a destinatari en aquesta pàgina i fes una prova.",
        "alr.deliv_title": "Darrers lliuraments", "alr.deliv_desc": "Historial recent d'enviaments realitzats pel sistema.",
        "alr.th_date": "Data", "alr.th_title": "Títol",
        "alr.no_deliv": "Encara no hi ha lliuraments registrats.",
        # terminal.html
        "term.sidebar_machine": "Màquina", "term.sidebar_hint": "Tria una màquina per començar",
        "term.page_subtitle": "Tria la màquina i executa el que necessites, directament des del navegador.",
        "term.machine_sel": "Màquina seleccionada:",
        "term.hint": "Escriu una ordre i prem Enter.",
        "term.mode_label": "Mode:",
        "term.btn_run": "Executar",
        "term.quick_failed": "serveis fallits", "term.quick_ifaces": "interfícies",
        "term.warning": "Recorda: aquestes ordres són reals i s'executen al servidor. Les que tardin més del temps límit es tallaran automàticament.",
        "term.select_title": "Selecciona una màquina",
        ...
        "rec.aviso": "Aquesta guia et porta pas a pas per la recuperació del sistema. Segueix l'ordre. El <strong>pas 3 (restauració)</strong> és irreversible — assegura't d'haver verificat la còpia abans d'executar-lo.",
        "rec.steps_title": "Guia de recuperació — 6 passos",
        ...
        "rec.sidebar_steps": "Passos de la guia", "rec.sidebar_disk": "Disc usat",
        # cumplimiento.html
        "cum.page_title": "Compliment NIS2 / ENS / ISO 27001",
        "cum.page_subtitle": "Evidències tècniques automàtiques per control normatiu · Catàleg v1.0",
        "cum.aviso": "<strong>Important:</strong> aquest mòdul mostra l'evidència tècnica que Vigex genera automàticament. <strong>No certifica compliment normatiu</strong> — això requereix una auditoria formal per un organisme acreditat. Valida aquest informe contra la normativa real abans de presentar-lo a un auditor.",
        "cum.btn_collect": "Recollir evidències ara", "cum.btn_incidents": "Incidents NIS2",
        "cum.loading": "Carregant…",
        "cum.legend_full": "Completa", "cum.legend_partial": "Parcial", "cum.legend_none": "No coberta",
        "cum.js_fresh": "Fresca", "cum.js_expired_badge": "Caducada",
        "cum.js_noev": "Sense evidència", "cum.js_nocol": "Sense col·lector",
        "cum.js_last_run": "Darrera recollida: ", "cum.js_no_ev_yet": "Sense evidències recollides encara",
        "cum.js_fresh_card": "Evidències fresques", "cum.js_fresh_of_col": " famílies amb col·lector",
        "cum.js_expired_card": "Caducades", "cum.js_pending_suf": " sense recollir encara",
        "cum.js_attention": "Atenció:", "cum.js_ev_exp_in": "evidència caducada a",
        "cum.js_no_ev_in": "sense evidència a",
        "cum.js_banner_tail": ". Prem \"Recollir evidències ara\" per actualitzar.",
        "cum.js_all": "Totes", "cum.js_ev_title": "Darrera evidència recollida",
        "cum.js_no_filter": "Sense controls per a aquest filtre",
        "cum.js_generating": "Generant…", "cum.js_collecting": "Recollint…",
        "cum.js_collect_btn": "Recollir evidències ara", "cum.js_net_err": "Error de xarxa",
        "cum.js_load_err": "Error en carregar",
        # ── incidentes.html (R-095) ──
        "inc.page_title": "Incidents NIS2 — Cicle de vida",
        "inc.page_subtitle": "Terminis de notificació Art. 23 NIS2 · INCIBE-CERT (empreses) / CCN-CERT (AA.PP.)",
        "inc.info": "<strong>NIS2 Art. 23:</strong> les entitats essencials i importants han de notificar incidents significatius al CSIRT en <strong>≤ 24 h</strong> (avís preliminar) i <strong>≤ 72 h</strong> (notificació completa) des que en tinguin coneixement. Fes servir els botons de plantilla per baixar el document preformatat.",
        "inc.btn_new": "Registrar incident", "inc.btn_export": "Exportar registre",
        "inc.btn_back": "Tornar a Compliment", "inc.loading": "Carregant…",
        "inc.modal_title": "Registrar nou incident",
        "inc.lbl_titulo": "Títol *", "inc.lbl_desc": "Descripció *",
        "inc.lbl_tipo": "Tipus *", "inc.lbl_sev": "Gravetat *",
        "inc.lbl_detected": "Moment de detecció (quan vas tenir-ne coneixement) *",
        "inc.lbl_sistemas": "Sistemes / serveis afectats",
        "inc.lbl_medidas": "Mesures immediates adoptades",
        "inc.ph_titulo": "Ex: Accés no autoritzat al servidor de logs",
        "inc.ph_desc": "Descriu què va passar, com es va detectar i quin és l'impacte conegut…",
        "inc.ph_select": "Seleccionar…", "inc.ph_sistemas": "Ex: Servidor de còpies, panell Vigex",
        "inc.ph_medidas": "Ex: Aïllament del servidor, canvi de credencials, notificació interna…",
        "inc.btn_cancel": "Cancel·lar", "inc.btn_submit": "Registrar",
        "inc.js_est_detectado": "Detectat", "inc.js_est_24h": "Avís 24 h enviat",
        "inc.js_est_72h": "Notificació 72 h enviada", "inc.js_est_resuelto": "Resolt",
        "inc.js_est_cerrado": "Tancat", "inc.js_trans_24h": "Marcar avís 24 h enviat",
        "inc.js_trans_72h": "Marcar notif. 72 h enviada", "inc.js_trans_resuelto": "Marcar com a resolt",
        "inc.js_trans_cerrado": "Tancar incident", "inc.js_vencido": "Vençut",
        "inc.js_dias": " dies ", "inc.js_horas": " h ", "inc.js_min": " min",
        "inc.js_plazo_24": "Avís 24 h", "inc.js_plazo_72": "Notif. 72 h",
        "inc.js_plazo_det": "Detectat fa",
        "inc.js_enviado": "✅ Enviat", "inc.js_vencido_24": "⚠️ Vençut",
        "inc.js_enviada": "✅ Enviada", "inc.js_vencida_72": "⚠️ Vençuda",
        "inc.js_resta": "Resta", "inc.js_kv_tipo": "Tipus", "inc.js_kv_sev": "Gravetat",
        "inc.js_kv_creado": "Creat per", "inc.js_kv_csirt": "Ref. CSIRT",
        "inc.js_kv_resuelto": "Resolt", "inc.js_sist_afect": "Sistemes afectats:",
        "inc.js_medidas": "Mesures adoptades:", "inc.js_tmpl_24": "Plantilla 24 h",
        "inc.js_tmpl_72": "Plantilla 72 h",
        "inc.js_confirm_pre": "Confirmeu l'avanç d'estat a \"",
        "inc.js_confirm_suf": "\"?",
        "inc.js_no_inc": "Sense incidents registrats", "inc.js_load_err": "Error en carregar",
        "inc.js_generating": "Generant…", "inc.js_export_btn": "Exportar registre",
        "inc.js_net_err": "Error de xarxa",
        # ── configuracion.html ──
        "cfg.page_title": "Configuració del panell",
        "cfg.page_subtitle": "Ajusta els paràmetres operatius sense necessitat d'editar config.env manualment.",
        "cfg.btn_notif": "Veure notificacions",
        "cfg.banner_off": "Les alertes automàtiques estan <strong>desactivades</strong>. Els valors que configuris aquí es desen, però no s'enviaran alertes fins que activis <code>NOTIF_ENABLED=true</code> a <code>config.env</code> i reiniciïs el tauler.",
        "cfg.sec_thresholds": "Notificacions proactives — llindars",
        "cfg.card_params_title": "Paràmetres operatius",
        "cfg.card_params_desc": "Els canvis s'apliquen a l'instant, sense reiniciar el tauler. També es desen a l'arxiu de configuració perquè no es perdin.",
        "cfg.lbl_disk": "Llindar de disc", "cfg.unit_disk": "% d'ús de disc (50 – 99)",
        "cfg.hint_disk": "S'envia alerta quan el disc supera aquest percentatge.",
        "cfg.lbl_interval": "Interval entre comprovacions",
        "cfg.unit_interval_pre": "segons (60 – 86 400) · ara: ", "cfg.unit_interval_suf": " min",
        "cfg.hint_interval": "Cada quant comprova el panell disc, còpia i serveis.",
        "cfg.lbl_cooldown": "Silenci entre alertes iguals",
        "cfg.unit_cooldown_pre": "segons (300 – 86 400) · ara: ", "cfg.unit_cooldown_suf": " h",
        "cfg.hint_cooldown": "Temps mínim entre dues alertes del mateix tipus per no saturar el canal.",
        "cfg.btn_save": "Desar canvis",
        "cfg.sec_smtp": "Correu electrònic — SMTP",
        "cfg.card_smtp_title": "Configuració de correu sortint",
        "cfg.card_smtp_desc": "Usat per a alertes, informes periòdics i notificacions a <strong>suport@vigex.es</strong>. Compatible amb Gmail, Outlook o un altre SMTP amb STARTTLS.",
        "cfg.lbl_provider": "Proveïdor de correu", "cfg.opt_provider_default": "— Selecciona el teu proveïdor —",
        "cfg.lbl_smtp_host": "Servidor SMTP", "cfg.hint_smtp_host": "S'omple automàticament en triar proveïdor, o escriu-lo tu.",
        "cfg.lbl_smtp_port": "Port", "cfg.hint_smtp_port": "587 (STARTTLS) · s'omple automàticament.",
        "cfg.lbl_smtp_user": "La teva adreça de correu", "cfg.hint_smtp_user": "El compte que envia els correus (ex: tu@gmail.com).",
        "cfg.lbl_smtp_pass": "Contrasenya", "cfg.pill_configured": "Configurada",
        "cfg.ph_pass_nochange": "Deixar buit per no canviar", "cfg.ph_pass_new": "Contrasenya (o contrasenya d'app)",
        "cfg.hint_pass_nochange": "Deixar buit si no la vols canviar.", "cfg.hint_pass_new": "Introdueix la teva contrasenya o contrasenya d'aplicació.",
        "cfg.lbl_email_from": "Remitent (FROM)", "cfg.hint_email_from": "Normalment igual que la teva adreça de correu.",
        "cfg.lbl_email_to": "Destinatari d'alertes", "cfg.hint_email_to": "A qui li arriben les alertes i informes?",
        "cfg.btn_save_smtp": "Desar configuració de correu",
        "cfg.sec_session": "Seguretat de sessió", "cfg.card_logout_title": "Auto-logout per inactivitat",
        "cfg.card_logout_desc": "Si l'usuari no interactua durant aquest temps, la sessió es tanca automàticament. Posa 0 per desactivar-ho.",
        "cfg.lbl_autologout": "Temps d'inactivitat (minuts)", "cfg.hint_autologout": "0 = desactivat · màxim 1440 (24 h)",
        "cfg.btn_save_short": "Desar",
        "cfg.sec_readonly": "Configuració de connexions (només lectura)",
        "cfg.card_creds_title": "Credencials i hosts",
        "cfg.card_creds_desc": "Aquests valors es canvien editant <code>config.env</code> i reiniciant el panell.",
        "cfg.ro_telegram": "Canal Telegram", "cfg.pill_ok_telegram": "Configurat",
        "cfg.pill_off": "Sense configurar", "cfg.ro_smtp": "Correu SMTP",
        "cfg.ro_ssh_key": "Clau de connexió segura", "cfg.ro_ssh_timeout": "Temps d'espera",
        "cfg.ro_notif": "Notificacions actives", "cfg.pill_notif_on": "Activades", "cfg.pill_notif_off": "Desactivades",
        "cfg.sidebar_module": "Configuració", "cfg.sidebar_threshold": "Llindar disc", "cfg.sidebar_interval": "Comprovació cada",
        "cfg.js_validation_nums": "Tots els camps han de ser números enters.",
        "cfg.js_saving": "Desant…", "cfg.js_saved": "Desat.", "cfg.js_save_err": "Error en desar.",
        "cfg.js_net_err": "Error de xarxa. Comprova la connexió amb el panell.",
        "cfg.js_smtp_host_req": "El servidor SMTP és obligatori.",
        "cfg.js_smtp_err": "Error.", "cfg.js_net_err_short": "Error de xarxa.",
        "cfg.js_logout_range": "Valor entre 0 i 1440 minuts.",
        "cfg.js_btn_save": "Desar canvis", "cfg.js_btn_save_smtp": "Desar configuració de correu",
        # ── informes.html ──
        "inf.page_title": "Informes periòdics",
        "inf.page_subtitle": "El panell genera i envia resums d'estat de forma automàtica. Sense entrar al panell.",
        "inf.last_send_pre": "Darrer enviament: ",
        "inf.banner_no_channel": "No tens cap canal d'enviament actiu. Per rebre informes, configura el correu o Telegram a la secció <strong>Configuració</strong>.",
        "inf.sec_config": "Configuració",
        "inf.card_plan_title": "Planificació d'informes",
        "inf.card_plan_desc": "Tria amb quina freqüència, per quin canal i què incloure a cada informe.",
        "inf.slbl_estado": "Estat", "inf.slbl_freq": "Freqüència",
        "inf.slbl_canal": "Canal", "inf.slbl_next": "Proper enviament en",
        "inf.st_active": "Actius", "inf.st_off": "Desactivats",
        "inf.toggle_label": "Activar informes automàtics",
        "inf.toggle_hint": "El panell enviarà l'informe segons la freqüència triada.",
        "inf.lbl_freq": "Freqüència",
        "inf.opt_diario": "Diari", "inf.opt_semanal": "Setmanal", "inf.opt_mensual": "Mensual",
        "inf.lbl_canal": "Canal d'enviament", "inf.opt_email_noconfig": " (sense configurar)",
        "inf.opt_both": "Correu + Telegram",
        "inf.sec_backups": "Còpies de seguretat", "inf.sec_disco": "Disc",
        "inf.sec_servicios": "Serveis", "inf.sec_alertas": "Alertes",
        "inf.lbl_content": "Contingut de l'informe",
        "inf.hint_min_sec": "Com a mínim una secció ha d'estar seleccionada.",
        "inf.btn_save": "Desar configuració", "inf.btn_send": "Enviar informe ara",
        "inf.sec_history": "Historial d'enviaments",
        "inf.card_hist_title": "Darrers informes enviats",
        "inf.card_hist_desc_pre": "Es conserven els darrers ",
        "inf.card_hist_desc_suf": " registres d'aquesta sessió.",
        "inf.th_date": "Data", "inf.th_canal": "Canal", "inf.th_status": "Estat",
        "inf.pill_sent": "Enviat", "inf.pill_err": "Error",
        "inf.no_history": "Encara no s'ha enviat cap informe. Utilitza el botó <strong>\"Enviar informe ara\"</strong> per fer una prova.",
        "inf.sidebar_module": "Informes", "inf.sidebar_status": "Estat", "inf.sidebar_freq": "Freqüència",
        "inf.js_min_sec": "Selecciona almenys una secció per a l'informe.",
        "inf.js_saving": "Desant…", "inf.js_btn_save": "Desar configuració",
        "inf.js_net_err": "Error de xarxa.",
        "inf.js_sending": "Enviant…", "inf.js_btn_send": "Enviar informe ara",
        # ── admin_users.html ──
        "usr.page_title": "Administració d'usuaris",
        "usr.sidebar_title": "Control", "usr.sidebar_total": "Total usuaris: ",
        "usr.sidebar_admin": "Admin protegit", "usr.sidebar_perms": "Permisos delegables: ",
        "usr.title": "Usuaris i permisos",
        "usr.subtitle": "Dona accés al teu equip i decideix què pot veure o gestionar cada persona.",
        "usr.btn_logs": "Historial d'accessos", "usr.role_admin": "Administrador",
        "usr.kpi_total": "Usuaris totals", "usr.kpi_perms": "Permisos disponibles",
        "usr.kpi_protected": "Compte protegit",
        "usr.card_create_title": "Crear nou usuari",
        "usr.lbl_username": "Usuari", "usr.ph_username": "Ex: tecnic1",
        "usr.lbl_password": "Contrasenya", "usr.ph_password": "Contrasenya de l'usuari",
        "usr.perms_label": "Permisos del panell", "usr.btn_create": "Crear usuari",
        "usr.card_list_title": "Usuaris creats", "usr.card_list_desc": "Llistat actual del sistema.",
        "usr.th_user": "Usuari", "usr.th_perms": "Permisos", "usr.th_actions": "Accions",
        "usr.admin_perms": "Tots", "usr.admin_not_del": "No eliminable",
        "usr.no_perms": "Sense permisos", "usr.btn_delete": "Eliminar",
        "usr.no_users": "Encara no hi ha usuaris creats.",
        # ── admin_login_logs.html ──
        "log.page_title": "Historial d'accessos",
        "log.sidebar_title": "Auditoria", "log.sidebar_records": "Registres: ",
        "log.sidebar_logins": "Entrades: ", "log.sidebar_logouts": "Sortides: ", "log.sidebar_last": "Darrer: ",
        "log.title": "Historial d'accessos al tauler",
        "log.subtitle": "Registre de qui ha entrat al tauler, quan i des d'on.",
        "log.btn_back": "Tornar a Administració", "log.role_pill": "Només admin",
        "log.kpi_shown": "Registres mostrats", "log.kpi_ok": "Correctes", "log.kpi_failed": "Fallits",
        "log.card_title": "Accessos al tauler",
        "log.card_desc": "Entrades correctes, intents fallits i tancaments de sessió de tots els usuaris.",
        "log.th_date": "Data", "log.th_action": "Acció", "log.th_result": "Resultat",
        "log.th_user": "Usuari", "log.th_role": "Rol", "log.th_ip": "IP origen",
        "log.th_ua": "Navegador / Client", "log.th_detail": "Detall",
        "log.no_logs": "Encara no hi ha logs d'inici o tancament de sessió.",
        # login
        "lgn.page_title": "Accés", "lgn.subtitle": "Accedeix al teu panell de gestió",
        "lgn.error_blocked_title": "Accés bloquejat temporalment.",
        "lgn.error_blocked_msg": "Massa intents fallits. Espera uns minuts abans de tornar-ho a intentar.",
        "lgn.error_creds": "Usuari o contrasenya incorrectes. Comprova les teves credencials.",
        "lgn.lbl_username": "Usuari", "lgn.ph_username": "El teu nom d'usuari",
        "lgn.lbl_password": "Contrasenya", "lgn.ph_password": "La teva contrasenya",
        "lgn.btn_enter": "Entrar al panell",
        "lgn.footer": "Vigex · Accés restringit al personal autoritzat",
        # soporte principal
        "sop.page_title": "Suport", "sop.title": "Suport Vigex",
        "sop.subtitle": "Tens algun problema o dubte? Explica'ns-ho aquí i t'ajudem.",
        "sop.btn_tickets": "Gestionar tiquets",
        "sop.ok_registered": "La teva sol·licitud ha arribat correctament.",
        "sop.ok_ref": "Referència interna:", "sop.ok_see": "Veure estat",
        "sop.err_save": "No hem pogut desar la sol·licitud. Torna-ho a intentar.",
        "sop.card_new": "Nova sol·licitud",
        "sop.lbl_empresa": "Empresa *", "sop.lbl_contacto": "Persona de contacte *",
        "sop.lbl_email": "Correu *", "sop.lbl_telefono": "Telèfon",
        "sop.lbl_tipo": "Tipus de sol·licitud", "sop.lbl_prioridad": "Prioritat percebuda",
        "sop.lbl_servicio": "Servei afectat", "sop.lbl_desc": "Descripció *",
        "sop.ph_desc": "Explica què passa, des de quan i quin impacte té.",
        "sop.lbl_evidencia": "Evidència opcional",
        "sop.ph_evidencia": "Enganxa aquí text d'error, enllaços interns o notes de captura.",
        "sop.btn_create": "Crear tiquet",
        "sop.card_last": "Darreres sol·licituds",
        "sop.card_last_desc": "Seguiment bàsic de sol·licituds registrades en aquest panell.",
        "sop.ticket_see": "Veure estat",
        "sop.no_tickets": "Encara no hi ha tiquets registrats.",
        # soporte_tickets
        "tic.page_title": "Tiquets de suport",
        "tic.title_soporte": "Tiquets de suport", "tic.sub_soporte": "Vista interna per a l'equip Vigex.",
        "tic.title_reportes": "Reportes del panell",
        "tic.sub_reportes": "Errors, suggeriments i preguntes enviades des del botó de reporte.",
        "tic.btn_ver_tickets": "Veure tiquets", "tic.btn_nuevo": "Nou tiquet",
        "tic.btn_reportes": "Veure reportes", "tic.btn_sync": "Sincronització",
        "tic.kpi_total": "Total tiquets", "tic.kpi_open": "Oberts",
        "tic.kpi_closed": "Tancats", "tic.kpi_central": "Pendents d'enviament",
        "tic.filter_estado": "Estat", "tic.filter_todos": "Tots", "tic.filter_todas": "Totes",
        "tic.filter_prioridad": "Prioritat", "tic.filter_tipo": "Tipus", "tic.filter_q": "Cerca",
        "tic.filter_ph_q": "ID, client, correu, servei...",
        "tic.btn_filter": "Filtrar", "tic.btn_retry": "Reintentar enviament central pendent",
        "tic.th_id": "ID", "tic.th_central": "CENTRAL", "tic.th_cliente": "Client",
        "tic.th_tipo": "Tipus", "tic.th_prioridad": "Prioritat", "tic.th_estado": "Estat",
        "tic.th_servicio": "Servei", "tic.th_fecha": "Data", "tic.sin_central": "Sense central",
        "tic.no_tickets": "No hi ha tiquets que coincideixin amb els filtres seleccionats.",
        # soporte_ticket_detalle
        "tdt.page_title": "Detall tiquet", "tdt.btn_back": "Tornar als tiquets",
        "tdt.btn_new": "Nou tiquet",
        "tdt.ok_updated": "Tiquet actualitzat correctament.",
        "tdt.err_update": "No s'ha pogut actualitzar el tiquet.",
        "tdt.card_info": "Informació del tiquet",
        "tdt.lbl_cliente": "Client", "tdt.lbl_contacto": "Contacte",
        "tdt.lbl_email": "Correu", "tdt.lbl_telefono": "Telèfon",
        "tdt.lbl_servicio": "Servei", "tdt.lbl_canal": "Canal",
        "tdt.lbl_fecha": "Data obertura", "tdt.lbl_creado": "Creat per",
        "tdt.card_estado": "Actualitzar estat i prioritat",
        "tdt.nota_obligatoria": "La nota és <strong>obligatòria</strong> — quedarà en l'historial del tiquet.",
        "tdt.lbl_estado": "Estat", "tdt.lbl_prioridad": "Prioritat",
        "tdt.ph_nota": "Escriu aquí el motiu del canvi, la resposta al client o les accions preses…",
        "tdt.lbl_nota": "Nota / Resposta al client",
        "tdt.btn_guardar": "Desar canvis",
        "tdt.card_desc": "Descripció", "tdt.card_evidencia": "Evidència",
        "tdt.evidencia_vacia": "Sense evidència registrada.",
        "tdt.card_jira": "Exportar a gestor extern",
        "tdt.jira_desc": "Text preparat per copiar en una altra eina de gestió (Jira, Zammad, etc.).",
        "tdt.btn_copy_jira": "Copiar text",
        "tdt.card_plantillas": "Plantilles de resposta",
        "tdt.plantillas_desc": "Selecciona una resposta tipus per copiar-la i enviar-la al client.",
        "tdt.lbl_plantilla": "Plantilla", "tdt.opt_plantilla": "Seleccionar plantilla",
        "tdt.lbl_uso": "Ús recomanat", "tdt.uso_default": "Selecciona una plantilla per veure el seu ús.",
        "tdt.btn_generar": "Generar resposta", "tdt.h_respuesta": "Resposta generada",
        "tdt.btn_copy_resp": "Copiar resposta",
        "tdt.card_historial": "Historial intern",
        "tdt.no_historial": "Encara no hi ha canvis registrats.",
        "tdt.card_sync": "Sincronització central",
        "tdt.btn_sync_central": "Sincronitzar estat des de central",
        "tdt.lbl_ticket_central": "Tiquet central", "tdt.sin_central": "Sense referència central",
        "tdt.lbl_sync_status": "Estat sincronització", "tdt.no_sync": "No sincronitzat",
        "tdt.lbl_sync_at": "Darrera sincronització", "tdt.lbl_sync_detail": "Detall sincronització",
        # soporte_sincronizacion
        "sin.page_title": "Sincronització suport",
        "sin.sidebar_title": "Sincronització", "sin.sidebar_total": "Total: ",
        "sin.sidebar_sent": "Enviats: ", "sin.sidebar_pending": "Pendents: ",
        "sin.sidebar_disabled": "Desactivats: ",
        "sin.title": "Estat d'enviament al suport central",
        "sin.subtitle": "Han arribat les teves sol·licituds al tauler central Vigex?",
        "sin.btn_tickets": "Tiquets", "sin.btn_retry": "Reintentar pendents",
        "sin.kpi_total": "Total local", "sin.kpi_sent": "Enviats",
        "sin.kpi_pending": "Amb problema", "sin.kpi_disabled": "Desactivats",
        "sin.kpi_nocentral": "Sense central",
        "sin.th_local": "Tiquet local", "sin.th_cliente": "Client",
        "sin.th_central_state": "Estat central", "sin.th_central_ticket": "Tiquet central",
        "sin.th_sync_at": "Darrer enviament", "sin.th_detail": "Detall",
        "sin.badge_sent": "Enviat", "sin.badge_error": "Amb problema",
        "sin.badge_disabled": "Desactivat", "sin.badge_nocentral": "Sense central",
        "sin.no_tickets": "No hi ha tiquets per al filtre seleccionat.",
        # soporte_ticket_estado_cliente
        "est.btn_back_sop": "Tornar a suport", "est.btn_back_panel": "Tornar al panell",
        "est.tracking_sub": "Seguiment de la sol·licitud registrada al panell Vigex.",
        "est.last_update": "Darrera actualització:",
        "est.card_datos": "Dades de la sol·licitud",
        "est.lbl_empresa": "Empresa", "est.lbl_contacto": "Persona de contacte",
        "est.lbl_email": "Correu", "est.lbl_telefono": "Telèfon",
        "est.lbl_servicio": "Servei afectat", "est.lbl_fecha": "Data d'obertura",
        "est.card_desc": "Descripció enviada", "est.card_evidencia": "Evidència aportada",
        "est.evidencia_vacia": "Sense evidència registrada.",
        "est.card_seguimiento": "Seguiment",
        "est.timeline_registered": "Sol·licitud registrada",
        "est.timeline_team_recv": "L'equip Vigex ha rebut la sol·licitud.",
        "est.timeline_current_pre": "Estat actual:",
        "est.pending_notice": "L'equip Vigex necessita informació addicional per continuar amb la sol·licitud.",
        "est.card_info": "Informació per al client",
        "est.info_text": "Aquesta vista mostra l'estat actual de la sol·licitud. Per afegir informació addicional, respon pel canal acordat amb l'equip Vigex indicant la referència",
        "est.info_muted": "La gestió tècnica interna, plantilles de resposta i sincronització central estan reservades a l'equip Vigex.",
        # soporte_faq
        "faq.page_title": "Preguntes freqüents", "faq.title": "Preguntes freqüents",
        "faq.subtitle": "Troba resposta ràpida als problemes més habituals de Vigex.",
        "faq.btn_ticket": "Obrir tiquet",
        "faq.ph_search": "Cerca per paraules: còpia, disc, telegram, connexió…",
        "faq.results_count_pre": "resultat(s) per a",
        "faq.see_all": "Veure totes", "faq.count_available": "preguntes disponibles.",
        "faq.no_results_pre": "No s'han trobat resultats per a \"",
        "faq.no_results_suf": "\".",
        "faq.no_results_link1": "Veure totes les preguntes",
        "faq.no_results_or": "o", "faq.no_results_link2": "obrir un tiquet",
        "faq.no_results_suffix": "si no trobes resposta.",
        "faq.sidebar_total": "Preguntes", "faq.sidebar_results": "Resultats",
        # asistente
        "ais.page_title": "Assistent IA", "ais.rag_docs": " documents indexats",
        "ais.btn_clear": "Netejar",
        "ais.ollama_no_detected": "Ollama no detectat.",
        "ais.ollama_no_model_pre": "Model ", "ais.ollama_no_model_suf": " no descarregat.",
        "ais.ollama_model_do": "Executa:", "ais.ollama_available": "Models disponibles:",
        "ais.ollama_none": "cap",
        "ais.empty_h3": "En què et puc ajudar?",
        "ais.empty_p": "Pregunta'm sobre còpies de seguretat, serveis, alertes, registres, monitoratge o recuperació davant desastres.",
        "ais.sug1": "Què faig si una còpia de seguretat ha fallat?",
        "ais.sug2": "El disc és al 90%, què faig?",
        "ais.sug3": "Com restauro una còpia de seguretat?",
        "ais.sug4": "Un servei apareix com a caigut, com el reinicio?",
        "ais.sug5": "Què signifiquen les alertes de Vigex?",
        "ais.sug6": "Com funciona la recuperació davant desastres?",
        "ais.ph_input": "Escriu la teva pregunta… (Enter per enviar, Shift+Enter per nova línia)",
        "ais.hint_model": "Respostes basades en la documentació de Vigex · Model:",
        "ais.thinking": "Pensant…", "ais.no_resp": "(Sense resposta)",
        # alertas_proactivas
        "prn.page_title": "Notificacions proactives",
        "prn.sidebar_title": "Notificacions",
        "prn.sidebar_active": "Actives", "prn.sidebar_inactive": "Desactivades",
        "prn.sidebar_interval": "Interval: ", "prn.sidebar_last": "Darrera: ",
        "prn.sidebar_runs": "Execucions: ",
        "prn.title": "Notificacions automàtiques",
        "prn.subtitle": "El panell vigila el disc, les còpies i els serveis, i t'avisa abans que hi hagi un problema.",
        "prn.pill_active": "Vigilant activament", "prn.pill_inactive": "Desactivades",
        "prn.btn_back": "Tornar a Alertes",
        "prn.notice_disabled": "Les notificacions proactives estan desactivades.",
        "prn.notice_hint": "Per activar-les, afegeix <code>NOTIF_ENABLED=true</code> a <code>config.env</code> i configura el correu a la secció <strong>Configuració</strong>.",
        "prn.check_disk_label": "Ús del disc (/)",
        "prn.check_disk_threshold": "Llindar:", "prn.check_disk_never": "Mai comprovat",
        "prn.check_backup_label": "Darrera còpia",
        "prn.check_services_label": "Serveis del servidor",
        "prn.check_inactive": "Inactius:",
        "prn.badge_ok": "OK", "prn.badge_alert": "Alerta", "prn.badge_nodata": "Sense dades",
        "prn.alerts_suf_1": " alerta enviada", "prn.alerts_suf_n": " alertes enviades",
        "prn.card_config": "Configuració activa",
        "prn.config_desc": "Els canvis s'apliquen a l'instant, sense reiniciar el tauler. També es desen a l'arxiu de configuració perquè no es perdin.",
        "prn.tg_on": "configurat", "prn.tg_off": "sense configurar",
        "prn.cfg_email_to": "Destinatari email", "prn.cfg_smtp": "Servidor SMTP",
        "prn.cfg_threshold": "Llindar de disc", "prn.cfg_interval": "Interval entre comprovacions",
        "prn.cfg_cooldown": "Silenci entre alertes",
        "prn.cfg_interval_unit": " minuts", "prn.cfg_cooldown_unit": " hores",
        "prn.cfg_last_run": "Darrera execució", "prn.cfg_never": "Encara no",
        "prn.card_check": "Executar comprovació ara",
        "prn.check_desc": "Llança les tres comprovacions en aquest moment sense esperar el proper cicle automàtic. Els resultats apareixeran a dalt en recarregar.",
        "prn.btn_check": "Comprovar ara",
        "prn.js_done_pre": "Comprovació executada a les ",
        "prn.js_done_suf": ". Recarrega per veure els resultats.",
        "prn.js_error_pre": "Error: ", "prn.js_no_conn": "No s'ha pogut connectar amb el servidor.",
        "prn.card_log": "Historial d'alertes enviades",
        "prn.log_desc_pre": "Darreres ", "prn.log_desc_suf": " alertes enviades en aquesta sessió del panell.",
        "prn.th_date": "Data / hora", "prn.th_type": "Tipus",
        "prn.th_tg": "Telegram", "prn.th_email": "Email",
        "prn.badge_sent": "Enviat", "prn.badge_not_sent": "No enviat",
        "prn.no_alerts": "Sense alertes enviades en aquesta sessió. Bona senyal.",
        # copias_salud
        "sal.page_title": "Integritat de còpies", "sal.title": "Integritat de còpies",
        "sal.subtitle": "Comprova que les teves còpies estan en bon estat i sense danys.",
        "sal.updated": "Actualitzat:", "sal.btn_refresh": "Verificar ara",
        "sal.btn_back": "Còpies",
        "sal.kpi_analyzed": "Còpies analitzades",
        "sal.kpi_analyzed_sub": "Darreres 30 entrades de l'historial",
        "sal.kpi_errors": "Errors detectats",
        "sal.kpi_errors_sub": "Còpies amb estat diferent d'OK",
        "sal.kpi_sha": "Amb verificació",
        "sal.kpi_sha_sub_pre": "De ", "sal.kpi_sha_sub_suf": " sense verificar",
        "sal.kpi_tables": "Taules BD",
        "sal.kpi_tables_noaccess": "Sense accés a la BD",
        "sal.kpi_tables_checked": "Comprovades automàticament",
        "sal.ssh_error_pre": "No s'ha pogut llegir el registre de còpies:",
        "sal.section_backups": "Còpies — estat i integritat",
        "sal.card_backup_title": "Verificació de còpies",
        "sal.card_backup_desc": "Estat de cada còpia registrada al sistema.",
        "sal.sha_missing_pre": "sense verificar — anteriors a l'activació de la comprovació.",
        "sal.th_id": "ID", "sal.th_date": "Data", "sal.th_type": "Tipus",
        "sal.th_db": "BD", "sal.th_state": "Estat", "sal.th_sha": "Verificació", "sal.th_size": "Mida",
        "sal.no_ssh": "No s'ha pogut connectar al servidor de còpies per llegir l'historial.",
        "sal.no_backups": "Encara no hi ha còpies registrades a l'historial.",
        "sal.section_db": "Base de dades de registres",
        "sal.card_db_desc_noaccess": "No s'ha pogut connectar:",
        "sal.card_db_desc_ok": "Comprovació automàtica de taules — tot en ordre.",
        "sal.no_db": "Sense connexió a la base de dades. Revisa les dades d'accés a la secció <strong>Configuració</strong>.",
        "sal.no_tables": "Sense taules detectades.",
        "sal.sidebar_ok": "Còpies OK", "sal.sidebar_sha": "Verificades", "sal.sidebar_tables": "Taules BD",
        "sal.verifying": "Verificant…",
    },
}
...
class AuthAndLogMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        public_routes = {"/login", "/health", "/set-lang"}
