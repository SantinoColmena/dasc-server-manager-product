...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "mon.autorefresh": "Auto-refresh: 30 s",
        "mon.loading": "Cargando…", "mon.connecting": "Conectando…",
        "mon.refresh_btn": "Actualizar ya",
        "mon.label_load": "Carga (1 min)", "mon.label_mem": "Memoria RAM",
        ...
        "mon.load_avg_title": "Promedios de carga del procesador",
        "mon.load_avg_desc": "Un valor < 1.0 es ideal. Por encima de los núcleos disponibles el servidor empieza a hacer cola.",
        "mon.load_1min": "1 minuto", "mon.load_5min": "5 minutos", "mon.load_15min": "15 minutos",
        "mon.no_data": "Sin datos del servidor",
        "mon.load_sub": "Promedio del último minuto",
        ...
        "mon.uptime_sub": "Tiempo sin reinicios",
        # logs.html
        ...
        "logs.cacti_title": "Monitorización externa", "logs.cacti_desc": "Acceso directo a Cacti desde el panel.",
        "logs.cacti_btn": "Abrir Cacti",
        "logs.table_title": "Eventos de Vigex Web",
        "logs.table_desc": "Últimos 100 registros de auditoría almacenados en base de datos.",
        "logs.th_fecha": "Fecha", "logs.th_origen": "Origen", "logs.th_tipo": "Tipo",
        "logs.th_usuario": "Usuario", "logs.th_recurso": "Recurso",
        "logs.th_resultado": "Resultado", "logs.th_detalle": "Detalle",
        "logs.empty": "No hay eventos para mostrar. Si la vista se abre vacía, revisa la conectividad con la base de logs.",
        # backups.html
        ...
        "bkp.msg_ok": "Backup ejecutado correctamente.", "bkp.msg_error": "Error al ejecutar el backup.",
        ...
        "bkp.help_inc_desc": "Guarda los cambios realizados desde el último backup registrado usando binary logs. Reduce espacio y permite mantener una cadena de copias incremental.",
        "bkp.help_diff_title": "Diferencial",
        "bkp.help_diff_desc": "Genera una copia con los cambios acumulados desde la última copia completa. Es útil cuando se quiere un equilibrio entre rapidez de restauración y menor volumen de almacenamiento.",
        ...
        "bkp.auto_title": "Automatización con CRON",
        "bkp.auto_desc": "Programa copias automáticas en el servidor de backups sin perder el control de dependencias.",
        "bkp.callout_warn_bold": "Control de dependencias:",
        "bkp.callout_warn_text": "las copias incrementales solo se pueden automatizar si ya existe una copia base de esa base de datos. Las diferenciales solo se pueden automatizar si ya existe una copia completa.",
        ...
        "bkp.field_retention": "Retención", "bkp.no_delete": "No borrar",
        ...
        "bkp.rules_full": "se puede programar siempre.", "bkp.rules_inc": "necesita una copia anterior válida de la misma BD.",
        "bkp.rules_diff": "necesita una copia completa previa de la misma BD.",
        "bkp.log_title": "Log de CRON", "bkp.log_desc": "Las ejecuciones automáticas escriben su salida en:",
        ...
        "bkp.no_autos": "No hay automatizaciones CRON creadas todavía.",
        ...
        "bkp.th_date": "Fecha", "bkp.th_file": "Archivo", "bkp.th_base": "Base", "bkp.th_binlog": "Rango binlog",
        ...
        "bkp.modal_full_title": "Backup completo", "bkp.modal_full_sub": "Recomendado como copia base del sistema",
        "bkp.modal_inc_title": "Backup incremental", "bkp.modal_inc_sub": "Ejecuta cambios desde el último backup registrado",
        "bkp.modal_inc_callout": "se genera a partir de los binary logs desde el último backup registrado.",
        "bkp.modal_diff_title": "Backup diferencial", "bkp.modal_diff_sub": "Ejecuta cambios desde el último backup completo",
        ...
        "bkp.restore_title": "Confirmar restauración", "bkp.restore_sub": "La base de datos será restaurada al punto seleccionado.",
        "bkp.restore_warn_bold": "Atención:", "bkp.restore_warn_pre": "esta operación modificará la base de datos",
        "bkp.restore_warn_post": ". Antes de restaurar, el sistema creará una copia preventiva automática del estado actual.",
        ...
        "alr.msg_ok": "Cambios guardados correctamente.", "alr.msg_error": "Se produjo un error al guardar los cambios.",
        ...
        "alr.stat_total": "Eventos totales", "alr.stat_total_sub": "Eventos registrados en SQLite",
        "alr.stat_ok": "Entregas correctas", "alr.stat_ok_sub": "Mensajes enviados correctamente",
        "alr.stat_error": "Entregas con error", "alr.stat_error_sub": "Revisar token, chat_id o conectividad",
        ...
        "cum.page_subtitle": "Evidencias técnicas automáticas por control normativo · Catálogo v1.0 · Fase 13 (R-093)",
        "cum.aviso": "<strong>Aviso de rigor:</strong> este módulo muestra la evidencia técnica que Vigex genera automáticamente. <strong>No certifica cumplimiento normativo</strong> — eso requiere una auditoría formal por un organismo acreditado. Antes de presentar este dossier ante un auditor debe validarse contra el texto normativo real (R-096).",
        ...
        "cfg.banner_off": "Las notificaciones proactivas están <strong>desactivadas</strong>. Los umbrales que configures aquí se guardan, pero las alertas automáticas no se enviarán hasta que actives <code>NOTIF_ENABLED=true</code> en <code>config.env</code> y reinicies el panel.",
        "cfg.sec_thresholds": "Notificaciones proactivas — umbrales",
        "cfg.card_params_title": "Parámetros operativos",
        "cfg.card_params_desc": "Los cambios se aplican al instante, sin reiniciar el panel. También se escriben en <code>config.env</code> para que persistan.",
        ...
        "cfg.ro_ssh_key": "Clave SSH", "cfg.ro_ssh_timeout": "Timeout SSH",
        ...
        "inf.banner_no_channel": "No hay ningún canal de envío configurado. Para recibir informes, configura <code>NOTIF_SMTP_*</code> (email) o <code>TELEGRAM_BOT_TOKEN</code> en <code>config.env</code> y reinicia el panel.",
        ...
        "usr.btn_logs": "Logs de sesión", "usr.role_admin": "Administrador",
        ...
        "log.page_title": "Logs de sesión",
        "log.sidebar_title": "Auditoría", "log.sidebar_records": "Registros: ",
        "log.sidebar_logins": "Logins: ", "log.sidebar_logouts": "Logouts: ", "log.sidebar_last": "Último: ",
        "log.title": "Auditoría de sesiones",
        "log.subtitle": "Registro de quién ha accedido al panel, cuándo y desde dónde.",
        ...
        "log.card_title": "Movimientos de autenticación",
        "log.card_desc": "Inicios de sesión correctos, intentos fallidos y cierres de sesión de cualquier usuario.",
        ...
        "sop.ok_registered": "Solicitud registrada correctamente.",
        "sop.ok_ref": "Referencia interna:", "sop.ok_see": "Ver estado",
        "sop.err_save": "No se pudo registrar la solicitud.",
        ...
        "tic.kpi_closed": "Cerrados", "tic.kpi_central": "Pendientes central",
        ...
        "tdt.card_jira": "Resumen para Jira/Zammad",
        "tdt.jira_desc": "Resumen técnico preparado para copiarlo en una herramienta externa de ticketing.",
        "tdt.btn_copy_jira": "Copiar resumen",
        ...
        "sin.title": "Sincronización local-central",
        "sin.subtitle": "Cola de tickets enviados al panel central Vigex.",
        "sin.btn_tickets": "Tickets", "sin.btn_retry": "Reintentar pendientes",
        "sin.kpi_total": "Total local", "sin.kpi_sent": "Enviados",
        "sin.kpi_pending": "Pendientes / error", "sin.kpi_disabled": "Desactivados",
        ...
        "sin.th_sync_at": "Última sync", "sin.th_detail": "Detalle",
        "sin.badge_sent": "Enviado", "sin.badge_error": "Pendiente / error",
        ...
        "faq.ph_search": "Busca por palabras clave: backup, disco, telegram, SSH…",
        ...
        "prn.notice_hint": "Para activarlas, añade <code>NOTIF_ENABLED=true</code> y configura las variables <code>NOTIF_SMTP_*</code> en <code>config.env</code> y reinicia el panel.",
        ...
        "prn.config_desc": "Leída de <code>config.env</code>. Para cambiar valores, edita el fichero y reinicia el panel. La edición desde el panel llegará en la Ruta 7.6.",
        ...
        "sal.subtitle": "Verifica que tus copias de seguridad están sanas y tienen su checksum.",
        ...
        "sal.kpi_sha": "SHA256 presentes",
        "sal.kpi_sha_sub_pre": "De ", "sal.kpi_sha_sub_suf": " sin checksum",
        "sal.kpi_tables": "Tablas BD",
        "sal.kpi_tables_noaccess": "Sin acceso a la BD",
        "sal.kpi_tables_checked": "Comprobadas con SHOW TABLE STATUS",
        "sal.ssh_error_pre": "No se pudo leer el historial de backups vía SSH:",
        "sal.section_backups": "Historial de copias — integridad",
        "sal.card_backup_title": "Verificación de copias",
        "sal.card_backup_desc": "Estado de cada copia según history.tsv.",
        "sal.sha_missing_pre": "sin SHA256 — creadas antes de activar la verificación.",
        "sal.th_id": "ID", "sal.th_date": "Fecha", "sal.th_type": "Tipo",
        "sal.th_db": "BD", "sal.th_state": "Estado", "sal.th_sha": "SHA256", "sal.th_size": "Tamaño",
        ...
        "sal.card_db_desc_ok": "Resultado de <code>SHOW TABLE STATUS</code> — sin indicadores de corrupción.",
        "sal.no_db": "Sin conexión a la base de datos. Comprueba <code>LOGS_DB_*</code> en <code>config.env</code>.",
        "sal.no_tables": "Sin tablas detectadas.",
        "sal.sidebar_ok": "Copias OK", "sal.sidebar_sha": "Con SHA256", "sal.sidebar_tables": "Tablas BD",
    ...
    "ca": {
        ...
        "mon.label_load": "Càrrega (1 min)", "mon.label_mem": "Memòria RAM",
        ...
        "mon.load_avg_title": "Mitjanes de càrrega del processador",
        "mon.load_avg_desc": "Un valor < 1.0 és ideal. Per sobre dels nuclis disponibles el servidor comença a fer cua.",
        "mon.load_1min": "1 minut", "mon.load_5min": "5 minuts", "mon.load_15min": "15 minuts",
        "mon.no_data": "Sense dades del servidor",
        "mon.load_sub": "Mitjana de l'últim minut",
        "mon.load_high": "Alta", "mon.load_med": "Moderada", "mon.load_ok": "Normal",
        ...
        "mon.uptime_sub": "Temps sense reinicis",
        # logs.html
        ...
        "logs.cacti_title": "Monitoratge extern", "logs.cacti_desc": "Accés directe a Cacti des del tauler.",
        "logs.cacti_btn": "Obrir Cacti",
        "logs.table_title": "Esdeveniments de Vigex Web",
        "logs.table_desc": "Darrers 100 registres d'auditoria emmagatzemats a la base de dades.",
        "logs.th_fecha": "Data", "logs.th_origen": "Origen", "logs.th_tipo": "Tipus",
        "logs.th_usuario": "Usuari", "logs.th_recurso": "Recurs",
        "logs.th_resultado": "Resultat", "logs.th_detalle": "Detall",
        "logs.empty": "No hi ha esdeveniments per mostrar. Si la vista s'obre buida, revisa la connectivitat amb la base de registres.",
        # backups.html
        ...
        "bkp.msg_ok": "Còpia executada correctament.", "bkp.msg_error": "Error en executar la còpia.",
        ...
        "bkp.help_inc_title": "Incremental",
        "bkp.help_inc_desc": "Desa els canvis realitzats des de la darrera còpia registrada usant registres binaris. Redueix l'espai i permet mantenir una cadena de còpies incremental.",
        "bkp.help_diff_title": "Diferencial",
        "bkp.help_diff_desc": "Genera una còpia amb els canvis acumulats des de la darrera còpia completa. És útil quan es vol un equilibri entre rapidesa de restauració i menor volum d'emmagatzematge.",
        ...
        "bkp.auto_title": "Automatització amb CRON",
        "bkp.auto_desc": "Programa còpies automàtiques al servidor de còpies sense perdre el control de dependències.",
        "bkp.callout_warn_bold": "Control de dependències:",
        "bkp.callout_warn_text": "les còpies incrementals només es poden automatitzar si ja existeix una còpia base d'aquesta base de dades. Les diferencials només es poden automatitzar si ja existeix una còpia completa.",
        ...
        "bkp.field_retention": "Retenció", "bkp.no_delete": "No esborrar",
        ...
        "bkp.rules_full": "es pot programar sempre.", "bkp.rules_inc": "necessita una còpia anterior vàlida de la mateixa BD.",
        "bkp.rules_diff": "necessita una còpia completa prèvia de la mateixa BD.",
        "bkp.log_title": "Registre de CRON", "bkp.log_desc": "Les execucions automàtiques escriuen la seva sortida a:",
        ...
        "bkp.no_autos": "No hi ha automatitzacions CRON creades encara.",
        ...
        "bkp.th_date": "Data", "bkp.th_file": "Fitxer", "bkp.th_binlog": "Rang binlog",
        ...
        "bkp.modal_full_title": "Còpia completa", "bkp.modal_full_sub": "Recomanada com a còpia base del sistema",
        "bkp.modal_inc_title": "Còpia incremental", "bkp.modal_inc_sub": "Executa canvis des de la darrera còpia registrada",
        "bkp.modal_inc_callout": "es genera a partir dels registres binaris des de la darrera còpia registrada.",
        "bkp.modal_diff_title": "Còpia diferencial", "bkp.modal_diff_sub": "Executa canvis des de la darrera còpia completa",
        ...
        "bkp.restore_title": "Confirmar restauració", "bkp.restore_sub": "La base de dades serà restaurada al punt seleccionat.",
        "bkp.restore_warn_bold": "Atenció:", "bkp.restore_warn_pre": "aquesta operació modificarà la base de dades",
        "bkp.restore_warn_post": ". Abans de restaurar, el sistema crearà una còpia preventiva automàtica de l'estat actual.",
        ...
        "alr.msg_ok": "Canvis desats correctament.", "alr.msg_error": "S'ha produït un error en desar els canvis.",
        ...
        "alr.stat_total": "Esdeveniments totals", "alr.stat_total_sub": "Esdeveniments registrats a SQLite",
        "alr.stat_ok": "Lliuraments correctes", "alr.stat_ok_sub": "Missatges enviats correctament",
        "alr.stat_error": "Lliuraments amb error", "alr.stat_error_sub": "Revisar token, chat_id o connectivitat",
        ...
        "cum.page_subtitle": "Evidències tècniques automàtiques per control normatiu · Catàleg v1.0 · Fase 13 (R-093)",
        "cum.aviso": "<strong>Avís de rigor:</strong> aquest mòdul mostra l'evidència tècnica que Vigex genera automàticament. <strong>No certifica compliment normatiu</strong> — això requereix una auditoria formal per un organisme acreditat. Abans de presentar aquest dossier davant d'un auditor s'ha de validar contra el text normatiu real (R-096).",
        ...
        "cfg.banner_off": "Les notificacions proactives estan <strong>desactivades</strong>. Els llindars que configuris aquí es desen, però les alertes automàtiques no s'enviaran fins que activis <code>NOTIF_ENABLED=true</code> a <code>config.env</code> i reiniciïs el panell.",
        "cfg.sec_thresholds": "Notificacions proactives — llindars",
        "cfg.card_params_title": "Paràmetres operatius",
        "cfg.card_params_desc": "Els canvis s'apliquen a l'instant, sense reiniciar el panell. També s'escriuen a <code>config.env</code> perquè persisteixin.",
        ...
        "cfg.ro_ssh_key": "Clau SSH", "cfg.ro_ssh_timeout": "Timeout SSH",
        ...
        "inf.banner_no_channel": "No hi ha cap canal d'enviament configurat. Per rebre informes, configura <code>NOTIF_SMTP_*</code> (correu) o <code>TELEGRAM_BOT_TOKEN</code> a <code>config.env</code> i reinicia el panell.",
        ...
        "usr.btn_logs": "Logs de sessió", "usr.role_admin": "Administrador",
        ...
        # ── admin_login_logs.html ──
        "log.page_title": "Logs de sessió",
        "log.sidebar_title": "Auditoria", "log.sidebar_records": "Registres: ",
        "log.sidebar_logins": "Inicis: ", "log.sidebar_logouts": "Tancaments: ", "log.sidebar_last": "Darrer: ",
        "log.title": "Auditoria de sessions",
        "log.subtitle": "Registre de qui ha accedit al panell, quan i des d'on.",
        ...
        "log.card_title": "Moviments d'autenticació",
        "log.card_desc": "Inicis de sessió correctes, intents fallits i tancaments de sessió de qualsevol usuari.",
        ...
        "sop.ok_registered": "Sol·licitud registrada correctament.",
        "sop.ok_ref": "Referència interna:", "sop.ok_see": "Veure estat",
        "sop.err_save": "No s'ha pogut registrar la sol·licitud.",
        ...
        "tic.kpi_closed": "Tancats", "tic.kpi_central": "Pendents central",
        ...
        "tdt.card_jira": "Resum per a Jira/Zammad",
        "tdt.jira_desc": "Resum tècnic preparat per copiar-lo en una eina externa de ticketing.",
        "tdt.btn_copy_jira": "Copiar resum",
        ...
        "sin.title": "Sincronització local-central",
        "sin.subtitle": "Cua de tiquets enviats al panell central Vigex.",
        "sin.btn_tickets": "Tiquets", "sin.btn_retry": "Reintentar pendents",
        "sin.kpi_total": "Total local", "sin.kpi_sent": "Enviats",
        "sin.kpi_pending": "Pendents / error", "sin.kpi_disabled": "Desactivats",
        ...
        "sin.th_sync_at": "Darrera sync", "sin.th_detail": "Detall",
        "sin.badge_sent": "Enviat", "sin.badge_error": "Pendent / error",
        ...
        "faq.ph_search": "Cerca per paraules clau: còpia, disc, telegram, SSH…",
        ...
        "prn.notice_hint": "Per activar-les, afegeix <code>NOTIF_ENABLED=true</code> i configura les variables <code>NOTIF_SMTP_*</code> a <code>config.env</code> i reinicia el panell.",
        ...
        "prn.config_desc": "Llegida de <code>config.env</code>. Per canviar valors, edita el fitxer i reinicia el panell. L'edició des del panell arribarà a la Ruta 7.6.",
        ...
        "sal.subtitle": "Verifica que les teves còpies de seguretat estan sanes i tenen el seu checksum.",
        ...
        "sal.kpi_sha": "SHA256 presents",
        "sal.kpi_sha_sub_pre": "De ", "sal.kpi_sha_sub_suf": " sense checksum",
        "sal.kpi_tables": "Taules BD",
        "sal.kpi_tables_noaccess": "Sense accés a la BD",
        "sal.kpi_tables_checked": "Comprovades amb SHOW TABLE STATUS",
        "sal.ssh_error_pre": "No s'ha pogut llegir l'historial de còpies via SSH:",
        "sal.section_backups": "Historial de còpies — integritat",
        "sal.card_backup_title": "Verificació de còpies",
        "sal.card_backup_desc": "Estat de cada còpia segons history.tsv.",
        "sal.sha_missing_pre": "sense SHA256 — creades abans d'activar la verificació.",
        "sal.th_id": "ID", "sal.th_date": "Data", "sal.th_type": "Tipus",
        "sal.th_db": "BD", "sal.th_state": "Estat", "sal.th_sha": "SHA256", "sal.th_size": "Mida",
        ...
        "sal.card_db_desc_ok": "Resultat de <code>SHOW TABLE STATUS</code> — sense indicadors de corrupció.",
        "sal.no_db": "Sense connexió a la base de dades. Comprova <code>LOGS_DB_*</code> a <code>config.env</code>.",
        "sal.no_tables": "Sense taules detectades.",
        "sal.sidebar_ok": "Còpies OK", "sal.sidebar_sha": "Amb SHA256", "sal.sidebar_tables": "Taules BD",
